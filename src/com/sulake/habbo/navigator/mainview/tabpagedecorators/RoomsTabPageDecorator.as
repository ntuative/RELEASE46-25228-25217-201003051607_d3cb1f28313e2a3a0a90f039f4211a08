package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private function startSearch() : void
      {
         ...
         if(_loc1_ == 0)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_242,Tabs.const_311);
         }
         else if(_loc1_ == 1)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_242,Tabs.const_705);
         }
         else
         {
            ...
            _navigator.mainViewCtrl.startSearch(Tabs.const_242,Tabs.const_311,"" + _loc3_);
         }
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_456 == null)
         {
            var_456 = IDropMenuWindow(_loc3_.findChildByName("roomCtgFilter"));
            var_456.procedure = onChangeFilter;
