package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_915:ISessionDataManager;
      
      private var var_914:RoomCreateViewCtrl;
      
      private var var_1803:RoomThumbnailRenderer;
      
      private var var_188:IHabboToolbar;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_609:RoomInfoViewCtrl;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_609 = new RoomInfoViewCtrl(this);
         var_914 = new RoomCreateViewCtrl(this);
         var_1803 = new RoomThumbnailRenderer(this);
         var_1017 = new GuestRoomPasswordInput(this);
         _doorbell = new GuestRoomDoorbell(this);
         var_385 = new Tabs(this);
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_281.startSearch(Tabs.const_198,Tabs.const_306,param1);
      ...
      override public function dispose() : void
      {
         ...
         if(var_915)
         {
            var_915.release(new IIDSessionDataManager());
            var_915 = null;
         }
         if(_catalog)
         {
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_188 != null)
         {
            var_188.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_124,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_188.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_124,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_915 = param2 as ISessionDataManager;
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_281.startSearch(Tabs.const_271,Tabs.const_200);
         var_385.getTab(Tabs.const_271).tabPageDecorator.tabSelected();
      }
