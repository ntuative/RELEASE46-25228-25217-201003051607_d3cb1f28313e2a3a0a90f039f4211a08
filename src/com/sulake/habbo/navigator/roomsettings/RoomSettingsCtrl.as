package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_2024:ITextWindow;
      
      private var var_407:IRoomSettingsCtrlOwner;
      
      private var _inRoom:Boolean;
      
      private var var_1249:TextFieldManager;
      ...
      private function populateForm() : void
      {
         ...
         var_1249.setText(_loc1_.description);
         var_1017.setText("");
         var_1253.setText("");
         ...
         setTag(var_882,_loc1_.tags[0]);
         setTag(var_884,_loc1_.tags[1]);
         if(var_1252)
         {
            if(_loc1_.allowPets)
            {
      ...
      {
         var _loc10_:* = null;
         var _loc1_:IWindowContainer = IWindowContainer(var_260.findChildByName("flat_controller_list"));
         var _loc2_:IButtonWindow = IButtonWindow(var_260.findChildByName("remove_flat_ctrl"));
         var _loc3_:IButtonWindow = IButtonWindow(var_260.findChildByName("remove_all_flat_ctrls"));
         var _loc4_:IWindow = var_260.findChildByName("flat_ctrls_caption_txt");
         var _loc5_:IWindow = var_260.findChildByName("flat_ctrls_info_txt");
         var _loc6_:IWindow = var_260.findChildByName("flat_ctrls_limit_txt");
         var _loc7_:IWindowContainer = IWindowContainer(var_260.findChildByName("flat_controllers_footer"));
         Util.hideChildren(var_260);
         var_260.findChildByName("ruler").visible = true;
         ...
         if(var_84.controllers.length > 0)
         {
            ...
            Util.moveChildrenToColumn(var_260,["flat_ctrls_caption_txt","flat_ctrls_limit_txt","flat_controller_list","flat_ctrls_info_txt","flat_controllers_footer"],_loc4_.y,5);
         }
         else
         {
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow(param1,"",HabboWindowType.const_57,HabboWindowStyle.const_36,HabboWindowParam.const_65,new Rectangle(0,0,100,20)));
      }
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         var_1519.visible = _inRoom;
         var_2023.visible = var_487;
         var_2024.visible = !var_487;
         if(var_487)
         {
         ...
         else
         {
            ...
            var_1255.visible = _inRoom;
            _navigator.thumbRenderer.refreshThumbnail(IWindowContainer(var_1255.findChildByName("picframe")),_navigator.data.enteredGuestRoom.thumbnail,false);
            var_1016.height = Util.getLowestPoint(this.var_1016) + 4;
         }
         var_1518.text = !!var_487 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(_window,[var_1521.name,var_1255.name,var_1016.name,var_1018.name,var_1251.name,var_1519.name],0,0);
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.description = var_1249.getText();
         ...
         switch(_loc4_.name)
         {
            ...
            case "doormode_password":
               ...
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_386;
         }
         ...
         _loc2_.allowPets = var_1252.isSelected;
         _loc2_.allowFoodConsume = var_1254.isSelected;
         _loc2_.allowWalkThrough = var_1250.isSelected;
         _loc2_.tags = new Array();
         addTag(var_882,_loc2_.tags);
         addTag(var_884,_loc2_.tags);
         this.clearErrors();
         this.var_1020 = _loc2_.roomId;
      ...
      {
         if(param1 != this.var_408 || var_1020 < 1)
         {
            return;
         }
         close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         var_1020 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1263)
         {
         ...
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1138)
         {
            this.var_1249.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         ...
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1198)
         {
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_729,onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_1011,onDoorModePasswordUnselect);
         ...
         this.var_1249 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("description")),255);
         this.var_882 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("tag1")),30);
         this.var_884 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("tag2")),30);
         ...
         this.var_1252 = ICheckBoxWindow(_window.findChildByName("allow_pets_checkbox"));
         this.var_1254 = ICheckBoxWindow(_window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1250 = ICheckBoxWindow(_window.findChildByName("allow_walk_through_checkbox"));
         var_1521 = IWindowContainer(_window.findChildByName("header_container"));
         var_1255 = IWindowContainer(_window.findChildByName("thumbnail_container"));
         var_1016 = IWindowContainer(_window.findChildByName("basic_settings_container"));
         var_1018 = IWindowContainer(_window.findChildByName("advanced_settings_container"));
         var_1519 = IWindowContainer(_window.findChildByName("switch_view_container"));
         var_1251 = IWindowContainer(_window.findChildByName("footer_container"));
         var_260 = IWindowContainer(_window.findChildByName("flat_controllers_container"));
         var_1019 = IWindowContainer(_window.findChildByName("password_container"));
         var_2024 = ITextWindow(_window.findChildByName("basic_caption"));
         var_2023 = ITextWindow(_window.findChildByName("advanced_caption"));
         var_1518 = ITextWindow(_window.findChildByName("switch_view_text"));
         var_1518.procedure = onSwitchView;
         var_1019.visible = false;
         if(!_inRoom)
         {
