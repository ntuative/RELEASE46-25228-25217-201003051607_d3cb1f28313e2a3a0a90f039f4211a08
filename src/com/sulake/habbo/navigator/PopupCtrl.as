package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      {
         var_331 = new Timer(500,1);
         var_289 = new Timer(100,1);
         super();
         _navigator = param1;
         var_1154 = param4;
         var_1688 = param2;
         _popupIndentLeft = param3;
         var_331.addEventListener(TimerEvent.TIMER,onDisplayTimer);
      ...
      public function dispose() : void
      {
         ...
         if(var_331)
         {
            var_331.removeEventListener(TimerEvent.TIMER,onDisplayTimer);
            var_331.reset();
            var_331 = null;
         }
         if(var_289)
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(var_47 == null)
         {
            var_47 = IWindowContainer(_navigator.getXmlWindow(var_1154));
            var_47.visible = false;
         ...
         var_47.x = _loc2_.x + var_1688 + param1.width;
