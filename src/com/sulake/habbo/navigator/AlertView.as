package com.sulake.habbo.navigator
{
   ...
   public class AlertView implements IDisposable
   {
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(_navigator.getXmlWindow(this.var_1154));
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(var_1433[var_1154]);
         if(_loc1_ != null)
         {
            _loc1_.dispose();
         }
         ...
         var _loc2_:Rectangle = Util.getLocationRelativeTo(var_256.desktop,var_256.width,var_256.height);
         var_256.x = _loc2_.x;
         var_256.y = _loc2_.y;
         var_1433[var_1154] = var_256;
      }
   }
}
