package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      public static const const_357:int = 10;
      
      private static const const_1097:int = 40;
      ...
      private var var_1974:Dictionary;
      ...
      public function RoomThumbnailRenderer(param1:HabboNavigator)
      {
         ...
         super();
         _navigator = param1;
         var_845 = new ThumbnailImageConfigurations(_navigator);
      ...
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_845.getImage(ThumbnailEditorModel.const_32,param2.imgId);
         if(_loc3_ == null)
         {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1096,_loc4_.y + const_1097 - _loc5_.height),null,null,true);
      }
      ...
      {
         return Point(this.var_1974[param1]);
      }
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_845.getImage(ThumbnailEditorModel.const_35,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_845.getImage(ThumbnailEditorModel.const_35,1);
         }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_845.getImage(ThumbnailEditorModel.const_52,param2);
         if(_loc3_ == null)
         {
      ...
      private function getLoc(param1:int, param2:int) : Point
      {
         ...
         return new Point(param1 * const_765 + _loc3_,param2 * const_1098);
      }
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         if(var_1231 == null)
         {
            var_1231 = _navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(var_1231,var_1231.rect,new Point(0,0),null,null,true);
      }
   }
}
