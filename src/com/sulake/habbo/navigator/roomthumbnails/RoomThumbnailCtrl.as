package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_2015:IWindowContainer;
      ...
      private function refreshTab() : void
      {
         ...
         setEnabled(var_1513,this._model.mode != ThumbnailEditorModel.const_52);
         setEnabled(var_1514,this._model.mode != ThumbnailEditorModel.const_32);
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1513 = IButtonWindow(find("top_tab"));
         var_1514 = IButtonWindow(find("obj_tab"));
         var_2015 = IWindowContainer(find("tile_grid"));
         var_2014 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1513,onTopTabButton);
         Util.setProcDirectly(var_1514,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_2015;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_357)
            {
      ...
      {
         var _loc1_:IWindowContainer = var_2014;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_57,HabboWindowStyle.const_36,HabboWindowParam.const_65,new Rectangle(0,0,param1.width,66)));
