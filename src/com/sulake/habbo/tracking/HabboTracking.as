package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_779:uint = 11;
      ...
      private var var_422:IHabboHelp;
      
      private var _coreComponent:CoreComponent;
      
      private var var_1064:int = -1;
      
      private var var_1307:LagWarningLogger = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_1307 = new LagWarningLogger();
         var_1308 = new Array(const_779);
         var _loc4_:int = 0;
         while(_loc4_ < const_779)
         {
            var_1308[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1135,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1190,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1214,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_512,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_810,String(0));
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               trackLoginStep(HabboLoginTrackingStep.const_1205);
               break;
            case HabboCommunicationEvent.const_525:
               trackLoginStep(HabboLoginTrackingStep.const_1360,String(_communication.port));
               break;
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_325:
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_175)
         {
            Component(var_175).events.addEventListener(HabboConfigurationEvent.const_155,onConfigurationLoaded);
            if(var_236 != null)
            {
               var_236.configuration = var_175;
            }
            if(var_235 != null)
            {
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         _adManager.events.addEventListener(AdEvent.const_475,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_810,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_512,String(true));
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_525,onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_549,onHotelViewEvent);
      ...
      private function onLagWarningEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case AvatarWalkWarpingWarningEvent.const_354:
               var_1307.registerWarning(LagWarningLogger.const_871);
         }
      }
         ...
         if(!disposed)
         {
            ...
            if(var_176)
            {
               if(true)
               {
                  ...
                  Component(var_176).events.removeEventListener(HabboFriendListTrackingEvent.const_325,onFriendlistTrackingEvent);
               }
            ...
            if(var_422)
            {
               if(true)
               {
                  var_422.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
                  var_422.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
               }
               var_422.release(new IIDHabboHelp());
               var_422 = null;
            }
            if(_roomEngine)
            {
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_175)
         {
            Component(var_175).events.removeEventListener(HabboConfigurationEvent.const_155,onConfigurationLoaded);
         }
      }
      ...
      {
         var_422 = param2 as IHabboHelp;
         var_422.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
         var_422.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
      }
      ...
      {
         trackLoginStep(HabboLoginTrackingStep.const_942);
         if(_coreComponent != null)
         {
            _coreComponent.events.removeEventListener(HabboLoginTrackingStep.const_942,onCoreRunning);
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            ++var_1556;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1556);
         }
         if(var_1064 > -1 && _loc2_ - var_1064 > 15000)
         {
            ++var_1555;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1555);
         }
         var_1064 = _loc2_;
         if(var_235 != null)
         {
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(_roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_251,onRoomAdClick);
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(var_176).events.addEventListener(HabboFriendListTrackingEvent.const_325,onFriendlistTrackingEvent);
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_549)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1274);
         }
