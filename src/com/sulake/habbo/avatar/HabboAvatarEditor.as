package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_561:AvatarEditorHandler;
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return var_661.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_1191)
         {
            ...
            var_13 = new Map();
            var_13.add(AvatarEditorCategory.const_995,new GenericModel(this));
            var_13.add(AvatarEditorCategory.const_44,new HeadModel(this));
            var_13.add(AvatarEditorCategory.const_291,new TorsoModel(this));
            var_13.add(AvatarEditorCategory.const_1262,new LegsModel(this));
            var_13.add(AvatarEditorCategory.const_959,new WardrobeModel(this));
            var_1191 = true;
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_561 = new AvatarEditorHandler(this,_communication);
      }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && var_983 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc14_.isSelectable && (_loc13_ || var_983 >= _loc14_.clubLevel))
               {
                  _loc17_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1585.clone() as IWindowContainer,param1,_loc14_);
                  _loc4_.push(_loc17_);
                  if(param2 != FigureData.const_55)
                  {
                     _loc18_ = 0;
            ...
            _loc15_ = param2 != FigureData.const_55;
            _loc16_ = Boolean(_loc9_ == "1");
            for each(_loc5_ in _loc7_.partSets)
            {
               _loc21_ = false;
               if(_loc5_.gender == FigureData.const_1284)
               {
                  _loc21_ = true;
               }
               ...
               if(_loc5_.isSelectable && _loc21_ && (_loc16_ || var_983 >= _loc5_.clubLevel))
               {
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_13.getValue(AvatarEditorCategory.const_959);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_661.getPalette(param1);
      }
      ...
      {
         var_661 = var_539.getFigureData(AvatarType.const_88);
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_539 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,onAvatarRendererReady);
      }
      ...
      public function openEditor(param1:IWindowContainer = null) : Boolean
      {
         ...
         else
         {
            if(var_224 == null)
            {
               var_224 = _windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_57,HabboWindowStyle.const_36,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               var_224.addChild(_view.window);
               var_224.center();
               var_224.visible = false;
            }
         ...
         _view.show();
         toggleAvatarEditorPage(AvatarEditorCategory.const_995);
         if(var_561 != null)
         {
            var_561.getWardrobe();
         }
