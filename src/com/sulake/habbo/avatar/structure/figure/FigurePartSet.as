package com.sulake.habbo.avatar.structure.figure
{
   public class FigurePartSet implements IFigurePartSet
   {
      ...
      public function FigurePartSet(param1:XML)
      {
         ...
         var_984 = String(param1.@gender);
         var_1625 = parseInt(param1.@club);
         var_1729 = Boolean(parseInt(param1.@colorable));
         ...
         for each(_loc2_ in param1.part)
         {
            ...
            if(_loc5_ != -1)
            {
               var_570.splice(_loc5_,0,_loc4_);
            }
            else
            {
               var_570.push(_loc4_);
         ...
         {
            var_1426.push(String(_loc3_.@parttype));
         }
      }
