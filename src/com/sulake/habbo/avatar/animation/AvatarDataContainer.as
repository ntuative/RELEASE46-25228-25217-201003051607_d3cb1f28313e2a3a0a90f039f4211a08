package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         _colorTransform = new ColorTransform(var_1396,var_1395,var_1394,_alphaMultiplier);
         var_937 = generatePaletteMapForGrayscale(var_1648,var_1649);
      }
      
      public function get reds() : Array
      {
         return var_937.getValue("reds") as Array;
      }
      ...
      {
         return var_937.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_937.getValue("greens") as Array;
      }
      ...
      {
         return var_937.getValue("alphas") as Array;
      }
