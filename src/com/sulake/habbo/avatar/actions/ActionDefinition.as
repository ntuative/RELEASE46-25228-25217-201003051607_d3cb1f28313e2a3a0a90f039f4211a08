package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         var_1643 = parseInt(param1.@precedence);
         var_1638 = String(param1.@activepartset);
         var_1639 = String(param1.@assetpartdefinition);
         var_1644 = String(param1.@lay);
         var_1185 = String(param1.@geometrytype);
         var_1640 = Boolean(parseInt(param1.@main));
         var_1642 = Boolean(parseInt(param1.@method_7));
         var_1645 = Boolean(parseInt(param1.@animation));
         var _loc2_:String = String(param1.@prevents);
         if(_loc2_ != "")
         {
            var_1122 = _loc2_.split(",");
         }
      ...
      {
         return var_1122.concat(getTypePrevents(param1));
      }
