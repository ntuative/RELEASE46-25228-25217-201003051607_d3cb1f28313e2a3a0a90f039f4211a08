package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1585:IWindowContainer;
      ...
      private var var_1443:Boolean = true;
      
      private var var_339:Timer;
      
      private var var_1442:ITabSelectorWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog)
      {
         ...
         if(var_1585 == null)
         {
            ...
            var_1585 = var_10.windowManager.buildFromXML(_loc5_.content as XML) as IWindowContainer;
         }
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!var_463)
         {
            ...
            var_463 = _windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            var_463.procedure = stripClubDialogEventProc;
            var_463.center();
         }
         else
         {
            var_463.visible = true;
            var_463.center();
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         var_1442 = _window.findChildByName("mainTabs") as ITabSelectorWindow;
         attachImages();
         updateAvatar();
      }
      ...
      public function updateAvatar() : void
      {
         ...
         if(var_697 != null)
         {
            toggleCategoryView(var_697,true);
         }
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         var_697 = param1;
         var_1442.setSelected(var_1442.getSelectableByName(param1));
         _window.invalidate();
      }
