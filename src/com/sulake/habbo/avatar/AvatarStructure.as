package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_401:PartSetsData;
      
      private var var_2006:PartOffsetData;
      
      private var var_849:AvatarActionManager;
      
      private var var_156:IAssetLibrary;
      
      private var var_2299:IAssetLibrary;
      
      private var var_1361:Boolean = false;
      
      private var var_2005:AvatarRenderManager;
      
      private var var_482:FigureData;
      ...
      private var var_1505:AvatarStructureDownloadSet;
      
      private var var_680:AnimationManager;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_156 = param2;
         var_2299 = param3;
         var_482 = new FigureData();
         var_401 = new PartSetsData();
         _animationData = new AnimationData();
         var_1505 = new AvatarStructureDownloadSet();
         var_680 = new AnimationManager();
         var_679 = param4;
         var_2006 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      {
         return var_849.getActionDefinitionWithState(param1);
      }
      ...
      {
         return var_849.getCanvasOffsets(param1,param2,param3);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_849.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_680.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.hasAddData())
               {
                  for each(_loc9_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc12_ = var_401.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = var_401.getActiveParts(param1.definition);
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int) : Array
      {
         ...
         var _loc6_:ActionDefinition = var_849.getDefaultActionType();
         var _loc7_:Array = var_401.getActiveParts(param3.definition);
         if(param3.definition.isAnimation)
         {
            _loc17_ = param3.definition.state + "." + param3.actionParameter;
            _loc8_ = var_680.getAnimation(_loc17_);
            if(_loc8_ != null)
            {
         ...
         for each(_loc14_ in param2.getPartTypeIds())
         {
            ...
            _loc23_ = var_482.getSetType(_loc14_);
            if(_loc23_ != null)
            {
               _loc24_ = var_482.getPalette(_loc23_.paletteID);
               if(_loc24_)
               {
                  ...
                  if(_loc25_ != null)
                  {
                     ...
                     for each(_loc26_ in _loc25_.parts)
                     {
                        if(_loc9_.indexOf(_loc26_.type) > -1)
                        {
                           ...
                           _loc13_ = var_401.getPartDefinition(_loc26_.type);
         ...
         for each(_loc11_ in _loc9_)
         {
            ...
            if(!_loc35_)
            {
               if(_loc7_.indexOf(_loc11_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_401.getPartDefinition(_loc11_);
                     _loc37_ = false;
                     _loc38_ = 1;
      ...
      private function onStructureReady(param1:Event = null) : void
      {
         ...
         {
            var_401.getPartDefinition("ri").appendToFigure = true;
            var_401.getPartDefinition("li").appendToFigure = true;
         }
         registerAnimations();
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         {
            case AvatarType.const_88:
               var_1505.add(new AvatarStructureDownload(var_156,_loc5_,var_482));
               break;
            case AvatarType.PET:
         }
         var_1505.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_680.getAnimation(param1);
      }
      ...
      {
         var_849 = new AvatarActionManager(var_156,var_679);
      }
      ...
      private function registerAnimations() : void
      {
         ...
         while(var_156.hasAsset("dance" + _loc1_))
         {
            ...
            var_680.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = var_482.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = var_482.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      {
         return var_849.sortActions(param1);
      }
   }
}
