package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private var var_1040:PaletteManager;
      ...
      {
         var _loc2_:* = null;
         _loc2_ = var_302.getValue(AvatarType.const_88) as AvatarStructure;
         if(_loc2_ != null)
         {
      ...
      private function init() : void
      {
         ...
         var_1040 = new PaletteManager(_loc1_,_loc3_);
         ...
         var_302.add(AvatarType.const_88,_loc5_);
      ...
      {
         var_628 = param1;
         if(var_628 == RenderMode.const_1141)
         {
            init();
         }
      }
      ...
      {
         var _loc3_:AvatarStructure = var_302.getValue(AvatarType.const_88) as AvatarStructure;
         if(_loc3_ == null)
         {
            return null;
         }
         return new AvatarImage(_loc3_,var_18,param1,param2,AvatarType.const_88);
      }
