package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      private static const const_751:String = "selection_arrow";
      
      private static const const_750:String = "tile_cursor";
      ...
      private static const const_1057:String = const_340;
      ...
      public static const const_653:String = "RCL_LOADER_READY";
      ...
      private var var_947:IEventDispatcher = null;
      
      private var var_1142:Map = null;
      ...
      public function RoomContentLoader()
      {
         var_450 = [];
         var_452 = [];
         var_1697 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_1693 = ["room_public","room_public_park","room_public_pool"];
         super();
         var_377 = new Map();
         _events = new Map();
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_304,_loc4_);
      ...
      {
         if(var_163 != null && var_163.hasWorldType(const_276 + param1))
         {
            return var_163.type;
         }
         return param1;
      ...
      public function dispose() : void
      {
         ...
         if(var_377 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc3_ = var_377.getWithIndex(_loc2_) as AssetLibrary;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = var_377.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            _loc4_ = var_546.getValue(_loc2_);
            if(_loc4_ != null)
            {
               _loc2_ = getContentType(_loc4_);
               _loc3_ = var_377.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      {
         return [const_340,const_486,ROOM_CONTENT,const_750,const_751];
      }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_1697.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_167 && _loc5_ != RoomObjectLogicEnum.const_104)
         {
            _loc6_ = "@shadow";
      ...
      {
         var _loc2_:String = var_451.getValue(param1) as String;
      ...
      public function getRoomObjectAdURL(param1:String) : String
      {
         ...
         {
            return var_547.getValue(param1);
         }
         return "";
      }
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1254);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(var_1693.indexOf(getVisualizationType(_loc5_)) >= 0)
            {
               _loc7_ = getVisualizationXML(_loc5_);
               _loc8_ = extractPublicRoomFromXML(_loc5_,_loc7_);
               var_1142.add(_loc5_,_loc8_);
               var_163 = _loc8_;
               extractPublicRoomFurnitures(_loc5_,_loc2_);
            }
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_304,_loc5_);
         }
         else
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_425,_loc5_);
         }
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         {
            return RoomObjectCategoryEnum.const_256;
         }
         return RoomObjectCategoryEnum.const_186;
      }
      ...
      private function continueInitilization() : void
      {
         if(var_1694)
         {
            ...
            if(var_947 != null)
            {
               var_947.dispatchEvent(new Event(const_653));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_163 != null)
         {
            return var_163.getWorldHeightScale(const_276 + param1);
         }
         return 1;
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            var_947 = param1;
            var_1698 = param2.getKey("flash.dynamic.download.url","furniture/");
            var_1696 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_1692 = param2.getKey("public.room.dynamic.download.url","");
            var_1695 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         }
         var_34 = const_749;
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_167 && _loc5_ != RoomObjectVisualizationEnum.const_104)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = var_406.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
      ...
      {
         if(getObjectCategory(const_276 + param1) == RoomObjectCategoryEnum.const_63)
         {
            return true;
         }
         return false;
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(var_1142.getValue(param1) != null)
         {
            var_163 = var_1142.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_405,onContentLoaded);
            _loc6_ = 0;
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_163 != null)
         {
            return var_163.getWorldScale(const_276 + param1);
         }
         return 32;
      }
