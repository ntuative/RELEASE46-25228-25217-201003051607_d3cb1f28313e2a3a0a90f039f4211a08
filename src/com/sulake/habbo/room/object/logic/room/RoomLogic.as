package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1406:int = 1500;
      
      private var var_1407:int = 255;
      
      private var var_1405:int = 255;
      
      private var var_1127:uint = 16777215;
      
      private var var_939:uint = 16777215;
      
      protected var var_77:RoomPlaneParser = null;
      
      private var var_757:int = 0;
      
      private var var_1247:int = 255;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomUpdateMessage.const_732:
                  _loc2_.setString(RoomObjectVariableEnum.const_718,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_537:
                  _loc2_.setString(RoomObjectVariableEnum.const_551,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_666:
                  _loc2_.setString(RoomObjectVariableEnum.const_500,_loc3_.value);
            }
            return;
         }
         ...
         if(_loc4_ != null)
         {
            ...
            switch(_loc4_.type)
            {
               case RoomObjectRoomMaskUpdateMessage.const_393:
                  ...
                  _loc7_ = true;
                  break;
               case RoomObjectRoomMaskUpdateMessage.const_676:
         ...
         if(_loc5_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_948,int(_loc5_.bgOnly));
            var_1127 = _color;
            var_1407 = var_1247;
            var_939 = _loc11_;
            var_1405 = _loc12_;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_847,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_516,16777215);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc7_.x >= 0 && _loc7_.x < _loc14_ && _loc7_.y >= 0 && _loc7_.y < _loc15_)
         {
            ...
            _loc4_.setNumber(RoomObjectVariableEnum.const_1247,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1375,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_147 || _loc13_ == RoomPlaneData.const_258)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(var_757)
         {
            ...
            {
               _loc7_ = var_1127 >> 16 & 255;
               _loc8_ = var_1127 >> 8 & 255;
               _loc9_ = var_1127 & 255;
               _loc10_ = var_939 >> 16 & 255;
               _loc11_ = var_939 >> 8 & 255;
               _loc12_ = var_939 & 255;
               _loc13_ = (_loc2_ - var_757) / var_1406;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = var_1407 + (var_1405 - var_1407) * _loc13_;
               _color = _loc3_;
               var_1247 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_516,_loc3_);
         }
      }
   }
}
