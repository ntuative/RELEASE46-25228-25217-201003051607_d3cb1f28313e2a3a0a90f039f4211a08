package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      public function getPlaneType(param1:int) : int
      {
         ...
         {
            return RoomPlaneData.const_949;
         }
      ...
      {
         var _loc11_:* = null;
         addPlane(RoomPlaneData.const_147,param1,param2,param3,[param4]);
         addPlane(RoomPlaneData.const_258,param1,param2,param3,[param4]);
         var _loc9_:Vector3d = Vector3d.crossProduct(param2,param3);
         var _loc10_:Vector3d = Vector3d.product(_loc9_,1 / _loc9_.length * -var_765);
         addPlane(RoomPlaneData.const_147,Vector3d.sum(param1,param3),param2,_loc10_,[_loc9_,param4]);
         if(param5)
         {
            addPlane(RoomPlaneData.const_147,Vector3d.sum(Vector3d.sum(param1,param2),param3),Vector3d.product(param3,-(param3.length + var_110) / param3.length),_loc10_,[_loc9_,param4]);
         }
         if(param6)
         {
            addPlane(RoomPlaneData.const_147,Vector3d.sum(param1,Vector3d.product(param3,-var_110 / param3.length)),Vector3d.product(param3,(param3.length + var_110) / param3.length),_loc10_,[_loc9_,param4]);
            if(param7)
            {
               _loc11_ = Vector3d.product(param2,var_765 / param2.length);
               addPlane(RoomPlaneData.const_147,Vector3d.sum(Vector3d.sum(param1,param3),Vector3d.product(_loc11_,-1)),_loc11_,_loc10_,[_loc9_,param2,param4]);
            }
         }
      }
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         ...
         var_621 = getFloorHeight(var_101);
         if(!param1)
         {
            createWallPlanes();
         }
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         if(param1 >= 0 && param1 < _width && param2 >= 0 && param2 < _height)
         {
            ...
            {
               if(param1 == var_326 || param1 == var_329)
               {
                  _loc5_ = false;
                  _loc6_ = var_328;
                  while(_loc6_ < var_327)
                  {
               ...
               if(param2 == var_328 || param2 == var_327)
               {
                  _loc7_ = false;
                  _loc8_ = var_326;
      ...
      private function addFloor(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean, param8:Number, param9:Number, param10:Number, param11:Number) : void
      {
         ...
         if(_loc12_)
         {
            ...
            if(param6)
            {
               ...
               _loc14_ = addPlane(RoomPlaneData.const_149,_loc13_,new Vector3d(0,0,-var_110),param2);
               if(_loc14_ != null)
               {
                  if(param8 > 0)
                  {
            ...
            if(param7)
            {
               ...
               _loc14_ = addPlane(RoomPlaneData.const_149,_loc13_,new Vector3d(0,0,-var_110),Vector3d.product(param2,-1));
               if(_loc14_ != null)
               {
                  if(param9 > 0)
                  {
            ...
            if(param4)
            {
               ...
               _loc15_ = addPlane(RoomPlaneData.const_149,_loc13_,new Vector3d(0,0,-var_110),Vector3d.product(param3,-1));
               if(_loc15_ != null)
               {
                  if(param11 > 0)
                  {
            ...
            if(param5)
            {
               ...
               _loc15_ = addPlane(RoomPlaneData.const_149,_loc13_,new Vector3d(0,0,-var_110),param3);
               if(_loc15_ != null)
               {
                  if(param10 > 0)
                  {
