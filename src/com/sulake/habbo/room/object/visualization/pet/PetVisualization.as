   ...
   public class PetVisualization extends RoomObjectSpriteVisualization
   {
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         if(_loc12_ > 0)
         {
            ...
            if(_loc17_ < AvatarAction.const_990)
            {
               _loc10_ = uint(int(Math.sin(Number(_loc17_) / 0 * 0) * 255));
               _loc11_ = _loc4_.getNumber(RoomObjectVariableEnum.const_879);
               var_501 = const_1112;
            }
         }
         var _loc13_:Boolean = false;
         var _loc14_:String = _loc4_.getString(RoomObjectVariableEnum.const_231);
         switch(_loc14_)
         {
         ...
         var _loc15_:Boolean = var_283 != _loc3_.getUpdateID() || var_208 != param1.scale || var_161 != _loc4_.getUpdateID();
         var _loc16_:Boolean = _isAnimating || var_501 > 0 || _loc13_;
         if(_loc15_ || _loc16_)
         {
            increaseUpdateId();
            _loc18_ = getTimer();
            ...
            if(var_556 != _loc7_)
            {
               for each(_loc36_ in var_415.getKeys())
               {
                  var_415.remove(_loc36_);
               }
               _loc6_ = null;
            }
            if(_loc6_ == null)
            ...
            _loc20_ = _loc4_.getNumber(RoomObjectVariableEnum.const_296);
            if(isNaN(_loc20_))
            {
               _loc20_ = _loc19_;
            }
            ...
            _loc21_ = _loc4_.getString(RoomObjectVariableEnum.const_231);
            _loc22_ = _loc4_.getString(RoomObjectVariableEnum.const_702);
            _loc6_.appendAction(AvatarAction.const_540,_loc21_,_loc22_);
            _loc23_ = false;
            if(_loc21_ == "lay")
            {
            ...
            _loc24_ = _loc4_.getString(RoomObjectVariableEnum.const_367);
            if(_loc24_ != null && _loc24_ != "")
            {
               _loc38_ = _loc4_.getNumber(RoomObjectVariableEnum.const_388);
               _loc39_ = 3;
            ...
            _loc25_ = _loc4_.getNumber(RoomObjectVariableEnum.const_363) > 0;
            if(_loc25_)
            {
            ...
            _loc30_ = _loc6_.getSprites().length + const_1111;
