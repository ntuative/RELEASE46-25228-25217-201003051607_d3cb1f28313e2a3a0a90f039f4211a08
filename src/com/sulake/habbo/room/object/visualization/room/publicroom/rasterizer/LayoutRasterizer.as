package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_1028:Point = null;
      
      private var var_490:Array;
      
      private var var_1026:LayoutRasterizerData = null;
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc11_:* = null;
         var_1027 = param1;
         var _loc3_:LayoutRasterizerData = var_62.getValue(var_685);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              var_1261 = RoomObjectVariableEnum.const_880;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              var_1261 = RoomObjectVariableEnum.const_876;
                           }
                           if(param2 != null)
                           {
      ...
      public function showAd(param1:IRoomObjectSpriteVisualization, param2:String = "", param3:Boolean = false) : void
      {
         ...
         {
            exchangeElementGraphics("billboard_img",var_1261);
         }
         ...
         if(param3)
         {
            ...
            _loc5_.tag = RoomObjectVariableEnum.const_477;
         }
         if(param2 != "")
         {
            _loc4_.visible = true;
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(var_2038);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != var_685)
         {
            ...
            _adBgIndex = -1;
            _adImgIndex = -1;
            var_1026 = var_62.getValue(var_685);
         }
      }
      ...
      {
         var _loc1_:LayoutRasterizerData = var_62.getValue(var_685);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = var_1026.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         param2.offsetX = int(_loc8_.@x) + _loc9_.offsetX + var_1028.x;
         param2.offsetY = int(_loc8_.@y) + _loc9_.offsetY + var_1028.y;
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(var_347.indexOf(_loc10_) >= 0 && var_491)
            {
