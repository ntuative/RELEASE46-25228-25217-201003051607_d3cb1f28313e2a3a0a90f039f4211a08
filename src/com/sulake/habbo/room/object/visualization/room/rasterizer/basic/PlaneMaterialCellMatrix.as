package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1170:int = const_316;
      ...
      public static const const_660:int = 6;
      
      public static const const_266:int = const_98;
      ...
      private var var_808:Vector3d = null;
      ...
      public function PlaneMaterialCellMatrix(param1:int, param2:int = 1, param3:int = 1, param4:Number = -1, param5:Number = 1, param6:Number = -1, param7:Number = 1)
      {
         ...
         var_1898 = param6;
         var_1897 = param7;
         var_808 = new Vector3d();
         if(var_1455 == const_660)
         {
            var_1203 = false;
         }
      }
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(var_1467 == const_98)
         {
            _loc5_ = new Rectangle(0,0,var_26.width,var_474);
         }
         else
         {
            _loc5_ = new Rectangle(0,0 - var_474,var_26.width,var_474);
         }
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(isStatic)
         {
            if(var_26 != null)
            {
               if(var_26.width == param2 && var_26.height == param3 && Vector3d.isEqual(var_808,param4))
               {
                  if(param1 != null)
                  {
