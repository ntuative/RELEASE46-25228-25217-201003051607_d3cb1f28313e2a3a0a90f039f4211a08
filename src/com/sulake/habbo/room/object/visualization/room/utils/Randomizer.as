package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1486:int = 1;
      ...
      private var var_1566:int = 16777216;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / var_1566 * param2);
      }
      ...
      {
         var _loc1_:int = var_2341 * var_1329 + var_2342;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
