package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class FloorRasterizer extends PlaneRasterizer
   {
      ...
      private function parseFloors(param1:XML) : void
      {
         ...
         while(_loc3_ < _loc2_.length())
         {
            ...
            if(XMLValidator.checkRequiredAttributes(_loc4_,["id"]))
            {
               ...
               if(var_350.getValue(_loc5_) == null)
               {
                  var_350.add(_loc5_,_loc7_);
               }
               else
               {
                  _loc7_.dispose();
      ...
      {
         var _loc13_:FloorPlane = var_350.getValue(param2);
         if(_loc13_ == null)
         {
            _loc13_ = var_350.getValue(const_739);
         }
         if(_loc13_ == null)
         {
            return null;
      ...
      override public function dispose() : void
      {
         ...
         if(var_350 != null)
         {
            ...
            {
               _loc2_ = var_350.getWithIndex(_loc1_) as FloorPlane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
