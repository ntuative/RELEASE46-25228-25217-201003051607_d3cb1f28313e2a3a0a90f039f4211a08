package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualizationPlanetObject
   {
      ...
      {
         var_702 = new Vector3d(0,0,0);
         _children = new Array();
         super();
         _name = param1;
         _index = param2;
         var_1354 = param3;
         var_2082 = param4 * 0 * 2 / 360;
         var_1535 = param5 * 0 * 2 / 360;
         _height = param6;
         var_868 = 0;
      }
      ...
      {
         var _loc3_:Number = var_1354 * Math.cos(var_868 + var_1535);
         var _loc4_:Number = var_1354 * Math.sin(var_868 + var_1535);
         var _loc5_:Number = _height;
         var_702.x = (_loc3_ - _loc4_) * (param2 / 2);
         var_702.y = (_loc4_ + _loc3_) * (param2 / 2) * 0.5 - _height * (param2 / 2);
         var_702.z = -int(4 * (_loc3_ + _loc4_) - 0.7);
         if(param1 != null)
         {
            var_702.add(param1);
         }
