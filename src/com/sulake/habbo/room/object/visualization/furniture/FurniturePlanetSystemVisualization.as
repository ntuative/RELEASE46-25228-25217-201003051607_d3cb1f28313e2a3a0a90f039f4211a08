package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private function readDefinition() : Boolean
      {
         ...
         var _loc3_:String = _loc2_.getString(RoomObjectVariableEnum.const_1002);
      ...
      {
         if(param1 < var_557.length)
         {
            return var_557[param1].y;
         }
      ...
      override protected function updateAnimation(param1:Number) : Boolean
      {
         ...
         if(var_222 != null)
         {
            ...
            {
               _loc2_ = var_222[_loc3_];
               _loc2_.update(var_557,var_1851,param1);
               _loc3_++;
            }
