package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class AnimatedFurnitureVisualization extends FurnitureVisualization
   {
      ...
      override protected function updateAnimation(param1:Number) : Boolean
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < _animationData.method_1(param1))
         {
            _loc5_ = null;
            ...
            if(_loc5_ == null || _loc5_.remainingFrameRepeats >= 0 && _loc7_ <= 0)
            {
               ...
               if(_loc6_ == AnimationFrame.const_904)
               {
                  _loc5_ = _animationData.getFrame(_loc4_,var_1352,var_464,param1);
               }
               else
               {
                  _loc5_ = _animationData.getFrameFromSequence(_loc4_,var_1352,_loc6_,_loc5_.activeSequenceOffset + 1,var_464,param1);
               }
