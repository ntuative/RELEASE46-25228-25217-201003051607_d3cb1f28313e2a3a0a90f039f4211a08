package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private const const_1416:int = 0;
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         var _loc6_:* = var_415.getValue(_loc5_) as IAvatarImage;
         var _loc7_:String = _loc4_.getString(RoomObjectVariableEnum.const_161);
         var _loc8_:Number = new Date().valueOf();
         var _loc9_:Boolean = false;
         var _loc10_:Number = _loc4_.getNumber(RoomObjectVariableEnum.AVATAR_TALK_TIMESTAMP);
         var _loc11_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_580);
         ...
         var _loc14_:Number = _loc8_ - var_1283;
         ...
         var _loc16_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_319);
         if(_loc16_ > 0)
         {
         ...
         var _loc20_:Boolean = var_283 != _loc3_.getUpdateID() || var_208 != param1.scale || var_161 != _loc4_.getUpdateID();
         var _loc21_:Boolean = _isAnimating || var_501 > 0;
         if(_loc20_ || _loc21_)
         {
            increaseUpdateId();
            --var_501;
            ...
            if(var_556 != _loc7_)
            {
               for each(_loc49_ in var_415.getKeys())
               {
                  var_415.remove(_loc49_);
               }
               _loc6_ = null;
            }
            if(_loc6_ == null)
            {
               ...
               var_415.remove(_loc5_);
               var_415.add(_loc5_,_loc6_);
               var_556 = _loc7_;
            }
            ...
            _loc25_ = _loc4_.getNumber(RoomObjectVariableEnum.const_296);
            if(isNaN(_loc25_) || _loc4_.getString(RoomObjectVariableEnum.const_231) == "float")
            {
               _loc25_ = _loc24_;
            }
            else
            ...
            _loc26_ = _loc4_.getString(RoomObjectVariableEnum.const_231);
            _loc27_ = _loc4_.getString(RoomObjectVariableEnum.const_702);
            _loc6_.appendAction(AvatarAction.const_540,_loc26_,_loc27_);
            _loc28_ = false;
            if(_loc26_ == "lay")
            {
            ...
            _loc29_ = _loc4_.getNumber(RoomObjectVariableEnum.const_367);
            if(_loc29_ > 0 && _loc6_.getScale() == AvatarScaleType.const_51)
            {
               _loc51_ = _loc4_.getNumber(RoomObjectVariableEnum.const_388);
               _loc52_ = 3;
               _loc53_ = _loc8_ - _loc51_;
               if(_loc53_ < _loc52_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_297,AvatarAction.const_1239[_loc29_]);
               }
            }
            _loc30_ = _loc4_.getNumber(RoomObjectVariableEnum.const_840);
            if(_loc30_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_928,_loc30_);
            }
            _loc31_ = _loc4_.getNumber(RoomObjectVariableEnum.const_987);
            if(_loc31_ > 0)
            {
               _loc54_ = _loc4_.getNumber(RoomObjectVariableEnum.const_793);
               _loc55_ = 5;
            ...
            if(_loc32_ > 0)
            {
               _loc57_ = _loc4_.getNumber(RoomObjectVariableEnum.const_623);
               _loc58_ = 100;
            ...
            _loc34_ = _loc4_.getNumber(RoomObjectVariableEnum.const_973);
            if(_loc33_ > 0)
            {
               _loc34_ = _loc33_;
            }
            if(_loc34_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_796,_loc34_);
            }
            if(_loc9_)
            {
               _loc6_.appendAction(AvatarAction.const_460);
            }
            _loc35_ = _loc4_.getNumber(RoomObjectVariableEnum.const_363) > 0;
            if(_loc35_ || _loc13_)
            {
               _loc6_.appendAction(AvatarAction.const_532);
            }
            if(_loc15_)
            {
               _loc6_.appendAction(AvatarAction.const_404);
            }
            _loc36_ = _loc4_.getNumber(RoomObjectVariableEnum.const_997);
            if(_loc36_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_538,_loc36_);
            }
            ...
            if(_loc4_.getNumber(RoomObjectVariableEnum.const_854))
            {
               _loc43_.visible = true;
               _loc40_ = null;
               _loc39_ = null;
      ...
      override public function dispose() : void
      {
         ...
         if(var_415 != null)
         {
            _loc1_ = var_415.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_415.getValue(_loc2_) as IAvatarImage;
               _loc3_.dispose();
            }
         }
