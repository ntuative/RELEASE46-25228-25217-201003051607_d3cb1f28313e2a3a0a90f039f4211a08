package com.sulake.habbo.messenger
{
   ...
   public class ConversationsTabView
   {
      ...
      private function onTabClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _loc4_ = param2.name == HabboMessenger.const_156 ? var_133.conversations.findConversation(param2.id) : var_133.conversations.openConversations[_loc3_ + var_133.conversations.startIndex];
            if(_loc4_ == null)
            {
               return;
            }
      ...
      private function refreshAsArrow(param1:int, param2:Boolean) : void
      {
         ...
         var _loc4_:int = 0 % var_1221;
         _loc3_.width = var_1221 + (!!param2 ? _loc4_ : 0);
      }
      ...
      private function refreshTabContent(param1:int, param2:Conversation) : Boolean
      {
         ...
         _loc3_.x = param1 * var_1221;
         _loc3_.width = var_1221;
         return false;
      }
   }
}
