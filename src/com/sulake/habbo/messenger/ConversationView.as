package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1080:int = 20;
      
      private static const const_756:int = 100;
       
      
      private var var_1894:IScrollbarWindow;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         ...
         var_1894 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      {
         if(param1 == Message.const_509)
         {
            return 4285887861;
         }
         if(param1 == Message.const_602)
         {
            return 4285887861;
         }
         return 4278190080;
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_646 || param3.type == Message.const_663 ? param3.time + ": " : "";
      ...
      private function refreshList() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,var_471.messages.length - const_756);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < var_471.messages.length)
         {
            refreshEntry(true,_loc1_,var_471.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      public function refresh() : void
      {
         ...
         if(var_471 == null || _loc1_.id != var_471.id)
         {
            var_471 = _loc1_;
            refreshList();
            afterResize();
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_756 + const_1080)
         {
            refreshList();
            afterResize();
         }
      ...
      private function onCloseButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_133.messengerView.refresh(true);
      }
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_133.send(new FollowFriendMessageComposer(var_471.id));
      }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1081;
         param1.invalidate();
      }
   }
}
