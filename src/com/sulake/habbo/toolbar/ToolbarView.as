package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_494:String = "LEFT";
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         var_198 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_57,HabboWindowStyle.const_1000,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         var_1031 = String(_loc7_.relocate_by_drag.@state) == "true";
         if(var_1031)
         {
         ...
         var_1263 = _loc7_.toolbar.@margin_bottom;
         var_1527 = _loc7_.toolbar.@min_group_margin;
         var_1528 = _loc7_.toolbar.@margin_to_extrabar;
         ...
         createGroupsFromXmlList(_loc8_,var_262,param1,param2,_window,var_261);
         createGroupsFromXmlList(_loc9_,var_581,param1,param2,var_198,var_261);
         alignWindows();
      }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,var_135,var_494,param3);
         }
      }
      ...
      private function alignWindows() : void
      {
         ...
         else
         {
            ...
            if(false)
            {
               ...
               {
                  _loc7_ = Number(Math.max(var_1527,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1263) / -1));
               }
               else
               {
                  _loc7_ = Number(Math.max(var_1527,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1263) / -1));
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,var_135,var_494);
         }
      }
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < var_581.length)
         {
            _loc2_ = var_581[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,var_494);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,var_135,var_494);
         }
      }
