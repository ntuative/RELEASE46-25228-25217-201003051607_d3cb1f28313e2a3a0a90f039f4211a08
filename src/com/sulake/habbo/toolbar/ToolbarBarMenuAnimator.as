package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1108:Number = 90;
      
      private static const const_772:int = 50;
      
      private static const const_1105:Number = 25;
      ...
      private var var_1055:ToolbarView;
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_1055.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      {
         var _loc2_:Point = var_1055.getIconLoc(param1.iconId);
      ...
      {
         return var_504[var_503.indexOf(param1)];
      }
      ...
      {
         return param1.x + param1.width < const_772 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_772 || param1.desktop.height - param1.y < const_1118;
      }
