package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_698,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_893,onHideWindowEvent);
         var_34 = true;
