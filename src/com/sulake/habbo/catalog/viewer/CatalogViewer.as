package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogViewer implements ICatalogViewer
   {
      ...
      private var var_1539:HabboCatalog;
      ...
      public function showCatalogPage(param1:int, param2:String, param3:IPageLocalization, param4:Array) : void
      {
         ...
         if(var_703 != null)
         {
            _container.removeChild(var_703.window);
            var_703.dispose();
         }
         var _loc5_:ICatalogPage = new CatalogPage(this,param1,param2,param3,param4,var_1539);
         var_703 = _loc5_;
      ...
      {
         return var_703.dispatchWidgetEvent(param1);
      }
