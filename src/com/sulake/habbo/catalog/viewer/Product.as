package com.sulake.habbo.catalog.viewer
{
   ...
   public class Product extends ProductGridItem implements IProduct, IGetImageListener
   {
      ...
      private var var_1198:IProductData;
      ...
      {
         super();
         var_1199 = param1.productType;
         var_1200 = param1.furniClassId;
         var_989 = param1.extraParam;
         var_988 = param1.productCount;
         var_1201 = param1.expiration;
         var_1198 = param2;
      ...
      public function initIcon(param1:IProductContainer, param2:IGetImageListener = null) : BitmapData
      {
         ...
         switch(productType)
         {
            ...
            case ProductTypeEnum.const_77:
               _loc6_ = _loc4_.getWallItemIcon(productClassId,param2,var_989);
               break;
