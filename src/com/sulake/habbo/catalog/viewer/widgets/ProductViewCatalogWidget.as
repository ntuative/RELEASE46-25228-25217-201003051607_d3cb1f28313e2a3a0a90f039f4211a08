package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1181:ITextWindow;
      
      private var var_1107:IScrollbarWindow;
      
      protected var var_1372:XML;
      
      private var var_1108:BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_531 != null)
         {
            var_531.visible = false;
            var_531.destroyGridItems();
         }
         if(var_1107 != null)
         {
         ...
         if(_loc3_ != null)
         {
            var_1181.text = "${" + _loc3_.name + "}";
            var_1180.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1181.text = "${" + _loc2_.localizationId + "}";
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_379:
                  _loc4_ = var_1108.clone();
                  if(var_531 != null)
                  {
                     var_531.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_531,var_1107,var_1372);
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_215:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_297,AvatarAction.const_631);
                              _loc13_.appendAction(AvatarAction.const_538,_loc6_.productClassId);
      ...
      {
         var_1181 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         ...
         var_1384 = new Point(var_82.x,var_82.y);
         var_531 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1107 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_531 == null)
         {
         ...
         var_1108 = _loc2_.content as BitmapData;
