package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function populateColourGrid() : void
      {
         ...
         var_297 = null;
         for each(_loc1_ in var_1336)
         {
            _loc2_ = page.viewer.catalog.windowManager.buildFromXML(var_1337) as IWindowContainer;
            ...
            if(_loc3_ != null)
            {
               _loc3_.bitmap = new BitmapData(var_651.width,var_651.height,true,0);
               _loc3_.bitmap.copyPixels(var_651,var_651.rect,new Point(0,0));
            }
