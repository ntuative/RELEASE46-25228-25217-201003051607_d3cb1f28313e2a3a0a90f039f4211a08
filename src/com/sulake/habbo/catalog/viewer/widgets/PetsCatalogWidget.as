package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function getPurchaseParameters() : String
      {
         ...
         if(var_368 >= var_286.length)
         {
            return "";
         }
         var petColor:IPetColor = var_286[var_368] as IPetColor;
         var color:uint = petColor.rgb;
         var breed:IBreed = var_529[var_1376] as IBreed;
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var_368 = param1.index;
         if(var_368 < 0 || var_368 > var_286.length)
         {
            var_368 = 0;
         }
         updateImage();
      ...
      override public function init() : void
      {
         ...
         var_749 = getPetTypeIndexFromProduct(_loc5_.localizationId);
         var_286 = [];
         var_529 = [];
         if(page && false && page.viewer.catalog)
         {
            ...
            {
               _loc11_ = _loc10_.avatarRenderManager.petDataManager.getPetData(var_749);
               if(_loc11_)
               {
                  var_529 = _loc11_.breeds;
         ...
         var _loc6_:int = 0;
         while(_loc6_ < var_529.length)
         {
            _loc12_ = var_529[_loc6_] as IBreed;
            _loc3_.push(_loc4_.getKey(getRaceLocalizationKey(var_749,_loc12_.id),getRaceLocalizationKey(var_749,_loc12_.id)));
            _loc6_++;
         }
         var_590.add(var_749,_loc5_);
      ...
      private function updateImage() : void
      {
         ...
         if(var_368 >= 0 && var_368 < var_286.length)
         {
            _loc7_ = var_286[var_368] as IPetColor;
            if(_loc7_ != null)
            {
               _loc2_ = uint(_loc7_.rgb);
            }
         }
         var _loc3_:IBreed = var_529[var_1376] as IBreed;
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImageNew(var_749,_loc3_.id,_loc2_,AvatarScaleType.const_51);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.initActionAppends();
         _loc4_.appendAction(AvatarAction.const_297,AvatarAction.const_522);
