package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_879:MarketPlaceOfferData;
      
      private const const_1417:int = 1;
      
      private const const_1631:int = 40;
      ...
      private function updateList() : void
      {
         ...
         if(!var_502)
         {
            ...
            var_502 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!var_502)
         {
            return;
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !_itemList || !var_502 || true)
         {
            return;
         }
         var _loc2_:IWindowContainer = var_502.clone() as IWindowContainer;
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_878 >= var_590.length)
            {
               return true;
            }
            addListItem(var_590.getWithIndex(var_878));
            ++var_878;
            _loc1_++;
         }
         return false;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_879.offerId);
            }
            return;
         }
