package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_796:PrizeViewer;
      ...
      override public function init() : void
      {
         ...
         var_1804 = _loc1_.content as XML;
         populateItemGrid();
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1804) as IWindowContainer;
      ...
      public function select(param1:IGridItem) : void
      {
         ...
         var_796.viewProduct(page.viewer.roomEngine,_loc3_,_loc2_.productItemType,_loc2_.productItemTypeId,_loc2_.title,_loc4_);
      }
