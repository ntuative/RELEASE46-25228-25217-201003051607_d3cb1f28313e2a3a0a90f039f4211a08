   ...
   public class MarketPlaceOwnItemsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private function updateList(param1:Map) : void
      {
         ...
         while(_loc7_ < _loc6_.length)
         {
            ...
            if(_loc11_.status == MarketPlaceOfferState.const_455)
            {
               _loc5_++;
            }
            ...
            if(_loc4_)
            {
               ...
               if(!(!_loc12_ || _loc12_.disposed))
               {
                  ...
                  if(_loc11_.status == MarketPlaceOfferState.const_820)
                  {
                  ...
                  if(_loc11_.status == MarketPlaceOfferState.const_843)
                  {
      ...
      override public function init() : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc2_)
            {
               _itemTemplates.add(MarketPlaceOfferState.const_820,_loc2_);
            }
         }
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc2_)
            {
               _itemTemplates.add(MarketPlaceOfferState.const_455,_loc2_);
            }
         }
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc2_)
            {
               _itemTemplates.add(MarketPlaceOfferState.const_843,_loc2_);
            }
         }
