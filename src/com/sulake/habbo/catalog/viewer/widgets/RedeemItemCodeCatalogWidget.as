package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         if(var_1009 != null)
         {
            var_1009.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_1010 != null)
         {
            var_1010.removeEventListener(WindowKeyboardEvent.const_150,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_1009 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_1009 != null)
         {
            var_1009.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_1010 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_1010 != null)
         {
            var_1010.addEventListener(WindowKeyboardEvent.const_150,windowKeyEventProcessor);
         }
      }
