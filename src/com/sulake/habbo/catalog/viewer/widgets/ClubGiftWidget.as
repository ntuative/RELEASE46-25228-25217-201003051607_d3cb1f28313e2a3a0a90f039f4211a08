package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubGiftWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private function showPreview(param1:Offer, param2:Rectangle) : void
      {
         ...
         if(!var_201)
         {
            var_201 = createWindow("club_gift_preview") as IWindowContainer;
         }
         if(!var_201)
         {
            return;
         }
         var _loc5_:IBitmapWrapperWindow = var_201.findChildByName("image") as IBitmapWrapperWindow;
         if(!_loc5_)
         {
            return;
         }
         ...
         var_201.setGlobalPosition(_loc6_.subtract(new Point(0,0)));
         var_201.visible = true;
         var_201.activate();
      }
      ...
      {
         if(!param1 || !param2 || !var_590 || !var_10)
         {
            return;
         }
