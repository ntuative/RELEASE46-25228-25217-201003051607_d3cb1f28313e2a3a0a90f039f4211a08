package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1465)
         {
            case RecyclerStatusMessageEvent.const_1339:
               var_258 = const_345;
               if(_view == null)
               {
                  return;
      ...
      {
         return var_1465 != RecyclerStatusMessageEvent.const_955;
      }
      
      private function get statusActive() : Boolean
      {
         return var_258 != const_755;
      }
      ...
      {
         return active && var_258 == const_345;
      }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_894:
               if(_view != null)
               {
