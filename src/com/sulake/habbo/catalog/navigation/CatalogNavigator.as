package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2333:String = "magic.pixels";
      
      private var var_2334:String = "catalog.page.club";
      ...
      private function openCreditsPage() : void
      {
         ...
         var _loc1_:* = _catalog.configuration.getKey("client.credits.embed.enabled","PetPlacingErrorParser") == "true";
         if(false && _loc1_)
         {
      ...
      {
         _catalog.openCatalogPage(var_2334,true);
      }
