package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      private var var_1601:MarketplaceItemStats;
      ...
      {
         if(param1.furniCategoryId != var_1606 || param1.furniTypeId != var_1605)
         {
            return;
         }
         var_1601 = param1;
      ...
      public function onCancelResult(param1:IMessageEvent) : void
      {
         ...
         if(parser.result == 1)
         {
            item = var_183.remove(parser.offerId);
            if(item != null)
            {
               item.dispose();
            }
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         else if(parser.result == 3)
         {
            ...
            showConfirmation(const_1516,updateItem);
            _visualization.listUpdatedNotify();
         }
      ...
      public function redeemSoldOffers() : void
      {
         var _loc2_:int = 0;
         var _loc3_:* = null;
         var _loc1_:Array = var_183.getKeys();
         for each(_loc2_ in _loc1_)
         {
            _loc3_ = var_183.getValue(_loc2_);
            if(_loc3_.status == MarketPlaceOfferState.const_455)
            {
               var_183.remove(_loc2_);
               _loc3_.dispose();
            }
         }
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         var_1603 = _loc3_.creditsWaiting;
         var_183 = new Map();
         for each(_loc4_ in _loc3_.offers)
         {
            ...
            var_183.add(_loc4_.offerId,_loc6_);
         }
      ...
      private function showConfirmation(param1:int, param2:MarketPlaceOfferData) : void
      {
         if(!var_193)
         {
            var_193 = new MarketplaceConfirmationDialog(this,_catalog,_roomEngine);
         }
      ...
      {
         requestOffers(var_1607,var_1602,var_1600,var_1604);
      }
