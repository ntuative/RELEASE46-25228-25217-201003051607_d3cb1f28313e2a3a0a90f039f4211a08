package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1406:uint = 4.293848814E9;
      
      private var var_1177:int;
      
      private const const_1622:uint = 4.291613146E9;
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = var_223.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == var_809;
               }
            }
            _loc4_++;
         }
      ...
      private function updatePreview() : void
      {
         ...
         _loc3_ = _loc2_.getFurnitureImage(var_809,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         return param1 % 2 == 0 ? uint(const_1406) : uint(const_1407);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               _catalog.purchaseProduct(var_703,var_80,var_978);
               dispose();
               break;
            case "cancel_button":
      ...
      private function selectHighlighted() : void
      {
         ...
         var _loc1_:IItemListWindow = var_223.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(var_257) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(var_809);
         var _loc8_:int = !!_loc6_ ? 0 : int(var_560[var_195]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_559[var_194]);
         _catalog.purchaseProductAsGift(var_703,var_80,var_978,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_136:
               ...
               if(var_1853 == _loc3_.text)
               {
                  return;
               }
               _loc4_ = _loc3_.text.toLowerCase();
               _loc5_ = [];
               for each(_loc7_ in var_211)
               {
                  if(_loc7_.toLowerCase().search(_loc4_) != -1)
                  {
                     _loc5_.push(_loc7_);
                  }
                  if(_loc5_.length >= const_1621)
                  {
                     break;
                  }
               }
               updateSuggestions(_loc5_);
               var_1853 = _loc3_.text;
               break;
            case WindowMouseEvent.const_47:
               showSuggestions(false);
               if(var_1178)
         ...
         if(_loc2_ != null)
         {
            ...
            switch(_loc6_.productType)
            {
               ...
               case ProductTypeEnum.const_215:
                  ...
                  break;
               case ProductTypeEnum.const_470:
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            var_1456 = _loc1_.stuffTypes;
            var_560 = _loc1_.boxTypes;
            var_559 = _loc1_.ribbonTypes;
            var_809 = var_1456[0];
            var_195 = var_560[0];
            var_194 = var_559[0];
            initColorGrid();
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         var _loc2_:IItemListWindow = var_223.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         _loc3_ = _loc2_.getListItemAt(var_257) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = getColor(var_257);
         }
         var_257 = param1;
         if(var_257 < 0)
         {
            var_257 = _loc2_.numListItems - 1;
         }
         if(var_257 >= _loc2_.numListItems)
         {
            var_257 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(var_257) as IWindowContainer;
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(var_223 == null)
         {
            var_223 = _window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(var_467 == null)
         {
