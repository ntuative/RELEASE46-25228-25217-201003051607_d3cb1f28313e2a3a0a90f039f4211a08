package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog
   {
      ...
      private var var_1845:GiftWrappingConfiguration;
      ...
      {
         return var_325.getProductData(param1);
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         var_151.credits = _loc3_.balance;
         updatePurse();
         if(!var_1843 && var_466 != null)
         {
            var_466.playSound(HabboSoundTypesEnum.const_865);
         }
         var_1843 = false;
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = var_325.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_77)
         {
            _loc3_ = var_325.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_93:
               var_1170 = param1.session.isPrivateRoom;
               if(var_83 != null)
               {
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         var_1845 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         var_972.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers);
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         var_151.clubDays = Math.max(0,_loc2_.daysToPeriodEnd);
         var_151.clubPeriods = Math.max(0,_loc2_.periodsSubscribedAhead);
         updatePurse();
      ...
      {
         var_188.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_124,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function updatePurse() : void
      {
         ...
         _localization.registerParameter("catalog.purse.creditbalance","balance",String(var_151.credits));
         _localization.registerParameter("catalog.purse.pixelbalance","balance",String(var_151.pixels));
         _localization.registerParameter("catalog.purse.clubdays","days",String(var_151.clubDays));
         _localization.registerParameter("catalog.purse.clubdays","months",String(var_151.clubPeriods));
         if(false)
         {
            return;
         }
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         var_151.pixels = _loc2_.amount;
         updatePurse();
         if(!var_1844 && var_466 != null)
         {
            var_466.playSound(HabboSoundTypesEnum.const_1010);
         }
         var_1844 = false;
      }
