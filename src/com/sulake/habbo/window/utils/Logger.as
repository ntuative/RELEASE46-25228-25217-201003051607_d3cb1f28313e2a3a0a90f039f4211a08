package com.sulake.habbo.window.utils
{
   ...
   public class Logger extends Component implements ILogger
   {
      ...
      private var var_1484:ICoreWindowManager;
      ...
      {
         var_1484 = param2 as ICoreWindowManager;
         _window = var_1484.create("Logger::Output",HabboWindowType.const_371,WindowStyle.const_299,0 | 0 | 0 | 0,new Rectangle(0,0,180,240),loggerEventProc,"Logger") as IFrameWindow;
         var_341 = var_1484.create("Logger::Output::Text",HabboWindowType.const_3,WindowStyle.const_299,0 | 0 | 0,new Rectangle(0,0,_window.content.width,_window.content.height),null,"") as ITextWindow;
