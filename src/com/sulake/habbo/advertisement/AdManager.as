package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_798:BitmapData = null;
      ...
      private var var_799:BitmapData = null;
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_475,0,0,_loc4_,var_1438,var_799,var_798));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_1814 = int(_config.getKey("interstitial.interval","30000"));
         var_1812 = int(_config.getKey("interstitial.show.time","5000"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1159 = _loc2_.imageUrl;
         var_1438 = _loc2_.clickUrl;
         if(var_1159 != "" && var_1438 != "")
         {
            _loc3_ = var_1159;
            ...
            _loc4_ = new URLRequest(var_1159);
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         var_1160 = _loc2_.imageUrl;
         var_1813 = _loc2_.clickUrl;
         var_655 = getTimer();
         if(var_1160 != "")
         {
            _loc3_ = var_1160;
            ...
            var_221.start();
            _loc4_ = new URLRequest(var_1160);
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_436,0,0,param1.bitmapData,var_1813));
            var_655 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_798 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function showInterstitial() : Boolean
      {
         ...
         var _loc1_:int = getTimer() - var_655;
         if(_loc1_ > var_1814)
         {
            ++var_1440;
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_445));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_799 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
