package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_28:
               ...
               {
                  _loc22_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_302);
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_859);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_930);
            ...
            case RoomObjectCategoryEnum.const_34:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_429)
               {
                  _loc12_ = "null";
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_919)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_224)
               {
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1162;
                  if(!_loc25_)
                  {
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1338);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = var_558.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = _container.avatarRenderManager.createPetImage(_loc4_,AvatarScaleType.const_51);
            var_558.add(_loc2_.petId,_loc5_);
         }
      ...
      {
         return [RoomSessionUserBadgesEvent.const_109];
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_290);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_629);
         _loc1_.push(RoomWidgetFurniActionMessage.const_689);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_724);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_709);
         ...
         _loc1_.push(RoomWidgetPetCommandMessage.const_728);
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_109:
      ...
      public function dispose() : void
      {
         ...
         if(var_558 != null)
         {
            _loc1_ = var_558.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_558.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_390)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_290:
            ...
            case RoomWidgetUserActionMessage.const_673:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_910,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_714:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_629:
            ...
            case RoomWidgetUserActionMessage.const_479:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_724:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_709:
            ...
            case RoomWidgetUserActionMessage.const_531:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_728:
