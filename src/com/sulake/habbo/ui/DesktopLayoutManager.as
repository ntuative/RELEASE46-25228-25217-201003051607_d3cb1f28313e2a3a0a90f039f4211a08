package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = var_52.getChildByTag(const_1121) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = var_52.findChildByTag(const_1121) as IWindowContainer;
         if(!_loc1_)
         {
            return null;
         }
      ...
      public function set toolbarOrientation(param1:String) : void
      {
         ...
         switch(param1)
         {
            case "LEFT":
               _loc2_.x = var_715;
               _loc2_.width = var_52.desktop.width - var_715;
               _loc2_.y = 0;
            ...
            case "TOP":
               ...
               _loc2_.y = var_715;
               _loc2_.height = var_52.desktop.height - var_715;
               break;
            case "BOTTOM":
               _loc2_.x = 0;
               _loc2_.width = var_52.desktop.width;
      ...
      public function setLayout(param1:XML, param2:IHabboWindowManager) : void
      {
         ...
         while(_loc5_ < var_52.numChildren)
         {
            ...
            {
               _loc4_.addEventListener(WindowEvent.const_281,trimContainer);
            }
            _loc5_++;
         }
      }
      ...
      public function addWidgetWindow(param1:IWindow) : Boolean
      {
         ...
         {
            if(String(_loc2_[_loc4_]).indexOf(const_1633) == 0)
            {
