package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_445:Point = null;
      ...
      {
         return [RoomSessionChatEvent.const_130];
      }
      ...
      public function dispose() : void
      {
         ...
         if(var_444 != null)
         {
            ...
            {
               _loc2_ = var_444.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_130:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_444.getValue(_loc15_) as BitmapData;
                           ...
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_321:
      ...
      {
         return [RoomWidgetChatMessage.const_590,RoomWidgetChatSelectAvatarMessage.const_603];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_590:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_130,_container.roomSession,0,"Version 25228-25217-201003051538");
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_603:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_767 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_767);
            }
            if(var_445 == null)
            {
               var_443.x = 0;
               var_443.y = 0;
               var_443.z = 0;
               var_445 = _loc4_.getScreenPoint(var_443);
               var_767 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_443.x = 0;
            var_443.y = 0;
            var_443.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_443);
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_445.x || _loc8_.y != var_445.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_445,_loc5_));
