package com.sulake.habbo.ui
{
   ...
   public class DoorbellWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return RoomWidgetEnum.const_97;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionDoorbellEvent.const_97:
      ...
      {
         return [RoomWidgetLetUserInMessage.const_717];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetLetUserInMessage.const_717:
      ...
      {
         return [RoomSessionDoorbellEvent.const_97,RoomSessionDoorbellEvent.const_128,RoomSessionDoorbellEvent.const_53];
      }
