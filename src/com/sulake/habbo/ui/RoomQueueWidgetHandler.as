package com.sulake.habbo.ui
{
   ...
   public class RoomQueueWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionQueueEvent.const_372:
               ...
               {
                  case RoomSessionQueueEvent.const_791:
                     _loc3_ = "null";
                     break;
                  case RoomSessionQueueEvent.const_912:
                     _loc3_ = "null";
               }
               if(_loc3_ == null)
               {
               ...
               if(_loc5_.length > 1)
               {
                  if(_loc4_ && _loc2_.queueTypes.indexOf(RoomSessionQueueEvent.const_936) != -1)
                  {
                     _loc6_ = _loc2_.getQueueSize(RoomSessionQueueEvent.const_936) + 1;
                     _loc7_ = true;
                  }
                  else
                  {
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetRoomQueueMessage.const_612);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomQueueMessage.CHANGE_TO_SPECTATOR_QUEUE:
               _container.roomSession.changeQueue(RoomSessionQueueEvent.const_912);
               break;
            case RoomWidgetRoomQueueMessage.const_664:
               _container.roomSession.changeQueue(RoomSessionQueueEvent.const_791);
               break;
            case RoomWidgetRoomQueueMessage.const_612:
               if(false)
               {
                  _container.catalog.openCatalogPage(CatalogPageName.const_229,true);
               }
         }
         return null;
      }
