   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            {
               _loc8_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_897,HabboToolbarIconEnum.MEMENU);
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_594,onFigureUpdate);
            }
            if(false)
            {
            ...
            if(false)
            {
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_368,onHelpTutorialEvent);
         ...
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_594,onFigureUpdate);
         ...
         if(var_8 != null)
         {
            (var_8 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_913,onAvatarEffectsChanged);
            (var_8 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_1006,onHabboClubSubscriptionChanged);
         }
         ...
         if(false)
         {
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_368,onHelpTutorialEvent);
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_99:
               ...
               break;
            case HabboHelpTutorialEvent.const_368:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_536);
         _loc1_.push(RoomWidgetDanceMessage.const_542);
         ...
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_696);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_501);
         _loc1_.push(RoomWidgetStopEffectMessage.const_628);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1291);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_963);
         _loc1_.push(RoomWidgetToolbarMessage.const_502);
         _loc1_.push(RoomWidgetToolbarMessage.const_579);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_539);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1150);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_968);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_684);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_670);
         _loc1_.push(RoomWidgetRedeemClubPromoMessage.const_504);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_601);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1288);
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_647));
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_670:
               ...
               break;
            case RoomWidgetWaveMessage.const_536:
               if(_container != null && false)
               {
               ...
               break;
            case RoomWidgetDanceMessage.const_542:
               if(_container != null && false)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_548:
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_501:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(_catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_683)
               {
                  _catalog.openCatalogPage(CatalogPageName.const_229,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_696:
               ...
               if(var_8 != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_951:
                        _catalog.openCatalogPage(CatalogPageName.const_1202,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_979:
                        var_8.toggleInventoryPage(InventoryCategory.const_270);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1160:
                        var_8.toggleInventoryPage(InventoryCategory.const_69);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1193:
                        break;
                     default:
            ...
            case RoomWidgetStopEffectMessage.const_628:
               ...
               break;
            case RoomWidgetSetToolbarIconMessage.const_1009:
               ...
               break;
            case RoomWidgetNavigateToRoomMessage.const_963:
            ...
            case RoomWidgetToolbarMessage.const_502:
               ...
               break;
            case RoomWidgetToolbarMessage.const_579:
               ...
               if(var_188 && false)
               {
                  var_188.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_415,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_539:
               ...
               if(_container)
               {
                  ...
                  if(false && _loc23_ == 0)
                  {
                     ...
                     if(_loc25_ && false)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_457,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_835));
                     }
                     _loc26_ = int(_container.config.getKey("avatar.editor.trial.promo")) > 0;
                     if(_loc26_ && true)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_457,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_1298));
                     }
                  }
                  if(false && _container.habboHelp.events)
                  {
                     _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_554));
                  }
               }
               break;
            case RoomWidgetRedeemClubPromoMessage.const_504:
            ...
            case RoomWidgetAvatarEditorMessage.const_643:
               if(false && _container.habboHelp.events)
               {
                  _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_503));
               }
               break;
            default:
