package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private var var_881:IHabboHelp = null;
      ...
      private var var_539:IAvatarRenderManager = null;
      ...
      private var var_325:ISessionDataManager = null;
      
      private var var_1730:uint = 16777215;
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         {
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_304,onRoomContentLoaded);
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_425,onRoomContentLoaded);
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_556,onRoomContentLoaded);
         }
      }
      ...
      public function init() : void
      {
         ...
         {
            var_645 = _roomEngine.loadRoomResources(var_37.roomResources);
            if(false)
            {
               var_1152 = false;
         ...
         {
            var_1151 = !_adManager.showInterstitial();
         }
         checkInterrupts();
      }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         _roomEngine.modifyRoomCanvas(var_37.roomId,var_37.roomCategory,var_251[0],_loc2_.width,_loc2_.height);
      ...
      public function dispose() : void
      {
         ...
         if(_friendList && false)
         {
            ...
            _friendList.events.removeEventListener(FriendRequestEvent.const_227,processEvent);
         }
         _friendList = null;
         var_164.dispose();
         var_164 = null;
         if(_roomEngine != null && false)
         {
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_304,onRoomContentLoaded);
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_425,onRoomContentLoaded);
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_556,onRoomContentLoaded);
         }
         _roomEngine = null;
         var_19 = null;
         var_781 = null;
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(var_1730);
      ...
      public function set layout(param1:XML) : void
      {
         ...
         if(var_188 != null)
         {
            var_164.toolbarSize = var_188.size;
            var_164.toolbarOrientation = var_188.orientation;
         }
      }
      ...
      public function canvasMouseHandler(param1:Event) : void
      {
         ...
         switch(_loc2_.type)
         {
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
               _loc3_ = "null";
               break;
            case WindowMouseEvent.const_238:
               _loc3_ = "null";
               break;
         ...
         if(_loc4_ == _loc2_.target)
         {
            ...
            _roomEngine.handleRoomCanvasMouseEvent(var_251[0],_loc6_,_loc7_,_loc3_,_loc2_.altKey,_loc2_.ctrlKey,_loc2_.shiftKey,_loc2_.buttonDown);
         }
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_529:
               ...
               if(var_714 != null && _loc3_ == RoomObjectCategoryEnum.const_34)
               {
                  _loc7_ = var_37.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_429)
                  {
            ...
            case RoomEngineObjectEvent.const_103:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_651,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
            ...
            case RoomEngineObjectEvent.const_473:
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc12_ = _roomEngine.getRoomNumberValue(var_37.roomId,var_37.roomCategory,RoomVariableEnum.const_585);
            _loc13_ = _roomEngine.getRoomNumberValue(var_37.roomId,var_37.roomCategory,RoomVariableEnum.const_518);
            _loc14_ = _roomEngine.getRoomNumberValue(var_37.roomId,var_37.roomCategory,RoomVariableEnum.const_499);
            _loc15_ = _roomEngine.getRoomNumberValue(var_37.roomId,var_37.roomCategory,RoomVariableEnum.const_616);
         ...
         _loc10_.addEventListener(WindowMouseEvent.const_238,canvasMouseHandler);
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_424:
               ...
               var_165 = _windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_289,WindowStyle.const_299,WindowParam.const_84) as IToolTipWindow;
      ...
      {
         if(var_645 == null || false)
         {
            return;
         }
         var _loc2_:int = var_645.indexOf(param1.contentType);
         if(_loc2_ != -1)
         {
      ...
      {
         if(var_19 != null && var_37 != null && var_1151 && var_1152)
         {
      ...
      public function set friendList(param1:IHabboFriendList) : void
      {
         ...
         if(_friendList)
         {
            ...
            _friendList.events.addEventListener(FriendRequestEvent.const_227,processEvent);
         }
      }
