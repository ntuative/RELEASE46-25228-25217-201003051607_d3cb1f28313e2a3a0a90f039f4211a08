package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_830:IDropMenuWindow;
      
      private var var_50:IFrameWindow;
      
      private var var_668:OffenceData;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         var_831 = IButtonWindow(var_48.getXmlWindow("modact_offence"));
         var_829 = IButtonWindow(var_48.getXmlWindow("modact_offencectg"));
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_830.selection < 0)
         {
            var_48.windowManager.alert("Alert","You must select ban lenght",0,onAlertClose);
            return;
         }
         var_48.connection.send(new ModBanMessageComposer(var_1211,var_392.text,getBanLength(),var_1210));
         this.dispose();
      }
      ...
      {
         var _loc1_:int = this.var_830.selection;
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_48.connection.send(new ModAlertMessageComposer(var_1211,var_392.text,var_1210));
         this.dispose();
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_669 = var_48.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_48.connection.send(new ModKickMessageComposer(var_1211,var_392.text,var_1210));
         this.dispose();
      }
      ...
      public function refreshCategorization() : void
      {
         ...
         {
            var_50.findChildByName("offence_txt").caption = this.var_668.name;
            var_50.findChildByName("offence_category").visible = true;
         }
         else if(this.var_669 != null)
         {
            this.refreshButtons("offences_cont",2,var_669.offences,var_831,onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,var_48.initMsg.offenceCategories,var_829,onOffenceCtgButton);
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         var_668 = var_669.offences[_loc3_];
         var_392.text = var_668.msg;
         var_292 = false;
         this.refreshCategorization();
      }
      ...
      {
         var_50 = IFrameWindow(var_48.getXmlWindow("modact_summary"));
         var_50.caption = "Mod action on: " + var_1478;
         ...
         var_48.disableButton(var_48.initMsg.alertPermission,var_50,"send_caution_but");
         var_48.disableButton(var_48.initMsg.kickPermission,var_50,"kick_but");
         var_48.disableButton(var_48.initMsg.banPermission,var_50,"ban_but");
         var_392 = ITextFieldWindow(var_50.findChildByName("message_input"));
         var_392.procedure = onInputClick;
         var_830 = IDropMenuWindow(var_50.findChildByName("banLengthSelect"));
         prepareBanSelect(var_830);
