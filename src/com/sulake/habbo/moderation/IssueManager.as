package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_842:String = "issue_bundle_open";
      
      public static const const_559:String = "issue_bundle_my";
      
      public static const const_978:String = "issue_bundle_picked";
      ...
      {
         var _loc2_:IssueHandler = var_1033.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      public function pickBundle(param1:int) : void
      {
         ...
         var_690 = var_690.concat(_loc2_.getIssueIds());
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(var_861.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
         ...
         if(_loc3_ == null)
         {
            for each(_loc4_ in var_137)
            {
               if(validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  var_861.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            ...
            var_861.add(param1.issueId,_loc2_);
         ...
         if(param1.state == IssueMessageData.const_134)
         {
            ...
            _loc8_ = var_862.indexOf(param1.issueId);
            if(_loc8_ == -1 && _loc6_)
            {
      ...
      {
         var _loc2_:* = var_1033.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         {
            var_56.soundManager.playSound(HabboSoundTypesEnum.const_852);
         }
      }
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = var_861.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = var_137.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
