package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private var var_1380:IIssueBrowserView;
      ...
      private var var_1379:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_321.view.width = var_210.container.width;
         var_321.view.height = var_210.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1606:
               if(var_1380 == null)
               {
                  var_1380 = new MyIssuesView(issueManager,this,var_210.container);
               }
               return var_1380;
            case const_1604:
               if(var_1381 == null)
               {
                  var_1381 = new OpenIssuesView(issueManager,this,var_210.container);
               }
               return var_1381;
            case const_1605:
               if(var_1379 == null)
               {
                  var_1379 = new PickedIssuesView(issueManager,this,var_210.container);
               }
               return var_1379;
            default:
               return null;
