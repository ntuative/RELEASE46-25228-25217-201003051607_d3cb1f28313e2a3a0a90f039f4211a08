package com.sulake.habbo.moderation
{
   ...
   public class ModerationMessageHandler
   {
      ...
      private function onCfhChatlog(param1:CfhChatlogEvent) : void
      {
         ...
         onChatlog("Call For Help Chatlog: " + _loc2_.data.callId,WindowTracker.const_980,_loc2_.data.callId,_loc3_,_loc4_);
      }
      ...
      private function onUserChatlog(param1:UserChatlogEvent) : void
      {
         ...
         onChatlog("User Chatlog: " + _loc2_.data.userName,WindowTracker.const_877,_loc2_.data.userId,_loc2_.data.rooms,_loc3_);
      }
