package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1474:IMessageComposer;
      ...
      {
         var_917 = IWindowContainer(var_48.getXmlWindow("chatlog_roomheader"));
         var_918 = IWindowContainer(var_48.getXmlWindow("chatlog_chatline"));
         var_425 = new Timer(300,1);
         var_425.addEventListener(TimerEvent.TIMER,onResizeTimer);
         var_50 = IFrameWindow(var_48.getXmlWindow("chatlog_frame"));
         ...
         var_48.connection.send(var_1474);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(var_917.clone());
         var _loc3_:ITextWindow = ITextWindow(_loc2_.findChildByName("room_name_txt"));
         if(param1.roomId > 0)
         {
            _loc3_.caption = param1.roomName;
            new OpenRoomTool(var_50,var_48,_loc3_,param1.isPublic,param1.roomId);
         }
         else
         {
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(var_918.clone());
         _loc4_.color = var_1355[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            new OpenUserInfo(var_50,var_48,_loc6_,param2.chatterId);
         }
