package com.sulake.habbo.moderation
{
   ...
   public class UserInfoFrameCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_838:UserInfoCtrl;
      ...
      {
         var_50 = IFrameWindow(var_48.getXmlWindow("user_info_frame"));
         var_50.caption = "User Info";
         var _loc1_:IWindow = var_50.findChildByTag("close");
         _loc1_.procedure = onClose;
         var_838 = new UserInfoCtrl(var_50,var_48,"",true);
         var_838.load(var_50.content,_userId);
         var_50.visible = true;
      }
