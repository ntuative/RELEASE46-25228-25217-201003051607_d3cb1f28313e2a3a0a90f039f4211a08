package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(var_1962.clone());
         ...
         new OpenRoomTool(var_50,var_48,_loc5_,param1.isPublic,param1.roomId);
         _loc5_.color = _loc4_;
      ...
      {
         var_1962 = IWindowContainer(var_48.getXmlWindow("roomvisits_row"));
         ...
         var_50 = IFrameWindow(var_48.getXmlWindow("roomvisits_frame"));
