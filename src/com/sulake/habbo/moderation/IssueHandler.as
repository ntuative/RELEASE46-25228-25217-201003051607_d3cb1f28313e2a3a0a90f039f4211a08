package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_420:UserInfoCtrl;
      
      private var var_56:ModerationManager;
      
      private var var_1063:UserInfoCtrl;
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         var_56.issueManager.releaseBundle(var_118.id);
         checkAutoHandling();
         dispose();
      }
      ...
      private function createView() : void
      {
         ...
         var_420 = new UserInfoCtrl(_window,var_56,_loc3_.message);
         var_1063 = new UserInfoCtrl(_window,var_56,_loc3_.message);
         var_420.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_118.getHighestPriorityIssue().reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(_window.findChildByName("reported_user_info"));
         if(false)
         {
            var_1063.load(_loc4_,var_118.reportedUserId);
         }
         else
         {
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         var_56.issueManager.closeBundle(var_118.id,1);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var_56.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_56,WindowTracker.const_980,_loc2_),_window,false,false,true);
      }
      ...
      {
         if(var_56 != null && false && var_118 != null)
         {
            var_56.issueManager.removeHandler(var_118.id);
         }
         this.dispose();
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            var_420 = new UserInfoCtrl(_window,var_56,_loc3_.message);
            var_420.load(IWindowContainer(_window.findChildByName("caller_user_info")),_loc2_);
         }
      }
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         var_56.issueManager.closeBundle(var_118.id,2);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         var_56.issueManager.closeBundle(var_118.id,3);
         checkAutoHandling();
         dispose();
      }
