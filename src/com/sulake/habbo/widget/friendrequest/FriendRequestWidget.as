package com.sulake.habbo.widget.friendrequest
{
   ...
   public class FriendRequestWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetFriendRequestUpdateEvent.const_350,eventHandler);
         param1.removeEventListener(RoomWidgetFriendRequestUpdateEvent.const_377,eventHandler);
      }
      ...
      private function eventHandler(param1:RoomWidgetFriendRequestUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFriendRequestUpdateEvent.const_350:
               var_229.add(param1.requestId,new FriendRequestDialog(this,param1.requestId,param1.userId,param1.userName));
               break;
            case RoomWidgetFriendRequestUpdateEvent.const_377:
      ...
      private function removeRequest(param1:int) : void
      {
         ...
         var _loc2_:FriendRequestDialog = var_229.getValue(param1) as FriendRequestDialog;
         if(!_loc2_)
         {
            return;
         }
         _loc2_.dispose();
         var_229.remove(param1);
         checkUpdateNeed();
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetFriendRequestUpdateEvent.const_350,eventHandler);
         param1.addEventListener(RoomWidgetFriendRequestUpdateEvent.const_377,eventHandler);
