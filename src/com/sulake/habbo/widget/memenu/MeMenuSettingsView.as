package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSettingsView implements IMeMenuView
   {
      ...
      private var var_665:MeMenuSettingsViewSlider;
      
      private var var_1470:BitmapData;
      
      private var var_1472:BitmapData;
      ...
      {
         var_664 = param1.volume;
         if(var_665 != null)
         {
            var_665.setValue(var_664);
         }
         setSoundsOffIcon();
         setSoundsOnIcon();
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(_loc5_ != null && _loc5_.content != null)
         {
            var_1472 = (_loc5_.content as BitmapData).clone();
         }
         var_665 = new MeMenuSettingsViewSlider(this,_window.findChildByName("volume_container") as IWindowContainer,_widget.assets,0,1);
         setSoundsOffIcon();
         setSoundsOnIcon();
      ...
      private function onButtonOut(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            ...
            case "sounds_on":
               if(var_664 != 1)
               {
                  setBitmapWrapperContent("sounds_on_icon",var_1472);
               }
         }
      }
      ...
      private function setSoundsOffIcon(param1:BitmapData = null) : void
      {
         ...
         {
            setBitmapWrapperContent("sounds_off_icon",var_1471);
         }
         else
         {
            setBitmapWrapperContent("sounds_off_icon",var_1469);
      ...
      private function setSoundsOnIcon(param1:BitmapData = null) : void
      {
         ...
         {
            setBitmapWrapperContent("sounds_on_icon",var_1470);
         }
         else
         {
            setBitmapWrapperContent("sounds_on_icon",var_1472);
