package com.sulake.habbo.widget.memenu
{
   ...
   public class ClubPromoView
   {
      ...
      public static const const_471:String = "CPV_MODE_TRIAL";
      
      public static const const_1166:String = "CPV_MODE_FULL";
      ...
      private const const_1123:String = "avatareditor_club_promo_image";
      ...
      public function ClubPromoView(param1:MeMenuWidget, param2:String = "", param3:String = "CPV_MODE_FULL")
      {
         ...
         if(!setPromoImage() && param2 != "")
         {
            ...
            _loc8_ = _widget.assets.loadAssetFromFile(const_1123,_loc7_,"image/png");
      ...
      {
         _widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_683));
      }
      ...
      private function setPromoImage() : Boolean
      {
         ...
         if(_widget.assets.hasAsset(const_1123))
         {
            _loc2_ = _widget.assets.getAssetByName(const_1123) as BitmapDataAsset;
            if(!_loc2_)
            {
               return false;
            }
      ...
      private function onRedeem(param1:WindowMouseEvent) : void
      {
         ...
         _loc3_ = new RoomWidgetRedeemClubPromoMessage(RoomWidgetRedeemClubPromoMessage.const_504,_loc2_.text,var_628 == const_471);
