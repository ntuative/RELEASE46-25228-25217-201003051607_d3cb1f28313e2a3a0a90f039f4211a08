   ...
   public class EffectView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_804 = _window.findChildByName("effect_hilite");
            var_804.visible = false;
         }
         var_802 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_803 = _window.findChildByName("loader_bar");
         if(var_803 != null)
         {
            var_396 = var_803.width;
            var_173.start();
            onUpdate();
         }
         if(false)
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_802 != null)
         {
            var_802.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_802.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
