package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuEffectsView implements IMeMenuView
   {
      ...
      public static const const_806:Number = 55;
      ...
      public function selectEffect(param1:EffectView) : void
      {
         ...
         {
            _widget.messageListener.processWidgetMessage(new RoomWidgetSelectEffectMessage(RoomWidgetSelectEffectMessage.const_548,param1.effect.type));
         }
         else
         {
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         {
            case "back_btn":
               _widget.changeView(MeMenuWidget.const_120);
               break;
            case "moreEffects_btn":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_951));
               break;
            case "hideEffects_btn":
               _widget.messageListener.processWidgetMessage(new RoomWidgetSelectEffectMessage(RoomWidgetSelectEffectMessage.const_615));
               break;
            default:
      ...
      public function updateEffects(param1:Array) : Boolean
      {
         ...
         for each(_loc3_ in param1)
         {
            ...
            var_530.push(_loc6_);
            _loc6_.window.y = _loc2_ * const_806;
            _loc2_++;
         }
         _loc4_ = 0;
         _loc5_ = 0 * const_806;
