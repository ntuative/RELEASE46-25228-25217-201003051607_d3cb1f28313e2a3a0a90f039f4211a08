package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSettingsViewSlider
   {
      ...
      private var var_758:MeMenuSettingsView;
      ...
      private function buttonProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_758.saveVolume(getValue(param2.x),false);
      }
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null && var_543 != null)
            {
               ...
               var_1408 = _loc1_.width - _loc2_.width;
            }
         }
      }
      ...
      {
         return int(var_1408 * (Number(param1 - var_631) / (var_940 - var_631)));
      }
      ...
      {
         return param1 / var_1408 * (var_940 - var_631) + var_631;
      }
   }
}
