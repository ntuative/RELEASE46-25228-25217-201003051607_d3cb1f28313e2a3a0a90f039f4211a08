package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      {
         _widget.onItemMouseOut(var_950,var_951,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_950,var_951,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1148 = param1.chatType;
         var_950 = param1.userId;
         var_777 = param1.userName;
         var_951 = param1.userCategory;
         _message = param1.text;
         var_1146 = param1.userX;
         var_186 = param1.userImage;
         var_949 = param1.userColor;
      ...
      public function renderView() : void
      {
         ...
         if(_loc18_ != null)
         {
            ...
            if(var_949 != 0)
            {
               _loc30_ = uint(var_949 >> 16 & 255);
               _loc31_ = uint(var_949 >> 8 & 255);
               _loc32_ = uint(var_949 >> 0 & 255);
            }
         ...
         if(_loc20_ != null)
         {
            if(var_1148 == RoomWidgetChatUpdateEvent.const_253)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_777);
            }
            else if(var_1148 == RoomWidgetChatUpdateEvent.const_265)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_777);
            }
            else
            {
      ...
      {
         _widget.onItemMouseDown(var_950,var_951,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.method_8(var_950,var_951,_roomId,_roomCategory,param1);
      }
