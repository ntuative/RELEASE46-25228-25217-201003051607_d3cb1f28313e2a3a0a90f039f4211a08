package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private static const const_1099:int = 18;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         var_155.state = RoomChatHistoryPulldown.const_225;
         ...
         var_42 = param2.createWindow("chatscroller","",HabboWindowType.const_907,HabboWindowStyle.const_39,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(var_226 > 0 && param2)
         {
            if(var_1239)
            {
               if(Math.abs(param1 - var_226) <= const_1014)
               {
                  return;
               }
               var_1239 = false;
            ...
            if(var_299)
            {
               ...
               _loc7_ = true;
               _loc8_ = true;
               if(var_42.scrollV < 1 - const_1099 / var_42.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || var_1504)
      ...
      public function showHistoryViewer() : void
      {
         if(!var_299 && !var_1118)
         {
            ...
            var_155.state = RoomChatHistoryPulldown.const_308;
            if(_widget != null)
            {
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         var_155.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_225);
      }
