package com.sulake.habbo.widget.chooser
{
   ...
   public class UserChooserWidget extends ChooserWidgetBase
   {
      ...
      private const const_1635:int = 0;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChooserContentEvent.const_563,onChooserContent);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_248,onUpdateUserChooser);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_712,onUpdateUserChooser);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChooserContentEvent.const_563,onChooserContent);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_248,onUpdateUserChooser);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_712,onUpdateUserChooser);
      }
