package com.sulake.habbo.widget.furniture.placeholder
{
   ...
   public class PlaceholderWidget extends RoomWidgetBase
   {
      ...
      private function method_2(param1:RoomWidgetShowPlaceholderEvent) : void
      {
         showInterface();
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetShowPlaceholderEvent.const_506,method_2);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetShowPlaceholderEvent.const_506,method_2);
      }
   }
}
