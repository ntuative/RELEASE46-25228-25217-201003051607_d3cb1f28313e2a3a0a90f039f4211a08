package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_497:DimmerViewColorGrid;
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_57,HabboWindowStyle.const_36,0 | 0,new Rectangle(const_1041,const_1040,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               var_497 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,_widget.windowManager,_widget.assets);
            }
         }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(var_497 != null)
         {
            var_497.setSelectedColorIndex(param1);
         }
         _widget.previewCurrentSetting();
      }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         selectTab(param1);
         var_1034 = _loc2_.light;
         if(var_349 != null)
         {
            var_349.setValue(var_1034);
         }
         var_368 = colors.indexOf(_loc2_.color);
         if(var_497 != null)
         {
            var_497.setSelectedColorIndex(var_368);
         }
