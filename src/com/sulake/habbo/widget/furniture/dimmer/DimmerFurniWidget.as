package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1072:Array = new Array(int(76.5),int(76.5));
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetDimmerUpdateEvent.const_527,onPresets);
         param1.addEventListener(RoomWidgetDimmerUpdateEvent.const_996,onHide);
      ...
      private function onDimmerState(param1:RoomWidgetDimmerStateUpdateEvent) : void
      {
         ...
         var_963 = param1.effectId;
         _color = param1.color;
         var_964 = param1.brightness;
         if(_view != null)
         {
            _view.update();
         }
         if(!validateBrightness(var_964,var_963))
         {
            return;
         }
         _loc2_ = new RoomWidgetDimmerPreviewMessage(_color,var_964,var_963 == 2);
      ...
      private function onPresets(param1:RoomWidgetDimmerUpdateEvent) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var_788 = param1.selectedPresetId - 1;
         _presets = new Array();
         var _loc2_:int = 0;
      ...
      public function removePreview() : void
      {
         ...
         _loc1_ = new RoomWidgetDimmerPreviewMessage(_color,var_964,var_963 == 2);
         messageListener.processWidgetMessage(_loc1_);
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetDimmerUpdateEvent.const_527,onPresets);
      }
      ...
      public function storeCurrentSetting(param1:Boolean) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         var _loc6_:DimmerFurniWidgetPresetItem = _presets[var_788] as DimmerFurniWidgetPresetItem;
