package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_1029 = _localization.getKey("widgets.chatinput.mode.whisper",":tell");
         var_2040 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_2039 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_686 = new Timer(1000,1);
         var_686.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_859 = new Timer(5000,1);
         var_859.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _window.addEventListener(WindowEvent.const_435,onWindowMoved);
         var_1262 = true;
         var_134 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_2041 = _loc2_.width + const_487 + _loc6_.width + const_1103;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1102,_loc8_.width) + const_487);
            _loc8_.x = _loc12_;
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == var_1029 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  var_134 = "";
               }
