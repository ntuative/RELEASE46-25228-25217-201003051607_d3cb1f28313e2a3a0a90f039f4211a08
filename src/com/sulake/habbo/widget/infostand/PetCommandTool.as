package com.sulake.habbo.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      public function PetCommandTool(param1:InfostandWidget)
      {
         ...
         _widget = param1;
         var_992 = new Map();
         var_357 = new Timer(const_1636);
         var_357.addEventListener(TimerEvent.TIMER,onButtonDisableTimeout);
      }
      ...
      {
         var _loc2_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_728,param1);
      ...
      {
         var_992.remove(param1);
         var_992.add(param1,param2);
         if(param1 != var_738)
         {
            return;
         }
      ...
      {
         var _loc2_:Array = var_992.getValue(var_738) as Array;
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               _widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_479,var_738));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_630,var_738,var_2244 + " " + _loc6_);
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc6_:Array = var_992.getValue(param1) as Array;
         if(_loc6_ == null)
         {
            updateCommandButtonsViewState(new Array());
            requestEnabledCommands(var_738);
         }
         else
         {
