package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1613:uint = 6710886;
      ...
      private const const_1614:String = "energy";
      ...
      private const const_1610:int = 158;
      
      private const const_1611:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_243:PetCommandTool;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(var_232 != null)
         {
            var_105 = var_232.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
      ...
      {
         if(var_105 == null || var_232 == null || var_60 == null)
         {
            return;
         }
         ...
         var_232.height = NaN;
         _window.width = Math.max(var_232.width,var_60.width);
      ...
      private function openTrainView() : void
      {
         if(var_243 == null)
         {
            var_243 = new PetCommandTool(_widget);
         }
         var _loc1_:InfoStandPetData = var_1111.getValue(var_738) as InfoStandPetData;
         if(_loc1_ != null)
         {
            var_243.showWindow(true);
            var_243.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         updateStateElement(const_1614,param1.energy,param1.energyMax);
         ...
         updateWindow();
         var_738 = param1.id;
         var_1111.remove(param1.id);
         var_1111.add(param1.id,param1);
         if(var_243 && var_243.isVisible() && param1.isOwnPet)
         {
            var_243.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:Array) : void
      {
         ...
         var_243.setEnabledCommands(param1,param2);
      }
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1610,const_1611,false);
         ...
         _loc5_.fillRect(_loc7_,const_1613);
         return _loc5_;
      }
