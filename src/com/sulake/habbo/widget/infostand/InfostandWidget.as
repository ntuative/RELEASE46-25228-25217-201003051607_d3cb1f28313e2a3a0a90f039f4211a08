package com.sulake.habbo.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private const const_1421:String = "infostand_user_view";
      
      private var var_311:InfoStandPetView;
      
      private var var_1111:InfoStandPetData;
      
      private var var_140:Timer;
      
      private var var_906:InfoStandFurniView;
      ...
      private const const_1424:String = "infostand_furni_view";
      
      private const const_1634:int = 3000;
      ...
      public function InfostandWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager)
      {
         ...
         _config = param4;
         var_906 = new InfoStandFurniView(this,const_1424);
         var_203 = new InfoStandUserView(this,const_1421);
         var_311 = new InfoStandPetView(this,const_1422);
         var_354 = new InfoStandBotView(this,const_1423);
         var_417 = new InfostandUserData();
         var_427 = new InfostandFurniData();
         var_1111 = new InfoStandPetData();
         var_140 = new Timer(const_1634);
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            var_203.setTags(param1.tags,var_2201);
         }
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetBadgeImageUpdateEvent.const_564,onBadgeImage);
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_479,var_311.getCurrentPetId()));
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetBadgeImageUpdateEvent.const_564,onBadgeImage);
      ...
      private function onRoomObjectRemoved(param1:RoomWidgetRoomObjectUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomObjectUpdateEvent.const_248:
               ...
               {
                  _loc2_ = param1.id == var_1111.roomIndex;
                  break;
               }
