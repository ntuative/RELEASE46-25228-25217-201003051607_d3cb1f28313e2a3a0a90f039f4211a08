package com.sulake.habbo.session.handler
{
   ...
   public class TeleportErrorHandler extends BaseHandler
   {
      ...
      private function onDoorNotInstalledMessage(param1:IMessageEvent) : void
      {
         ...
         if(listener && false)
         {
            listener.events.dispatchEvent(new RoomSessionErrorMessageEvent(RoomSessionErrorMessageEvent.const_977,_loc3_));
         }
      }
      ...
      private function onDoorOtherEndDeletedMessage(param1:IMessageEvent) : void
      {
         ...
         if(listener && false)
         {
            listener.events.dispatchEvent(new RoomSessionErrorMessageEvent(RoomSessionErrorMessageEvent.const_857,_loc3_));
         }
      }
   }
}
