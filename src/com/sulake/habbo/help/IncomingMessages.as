package com.sulake.habbo.help
{
   ...
   public class IncomingMessages
   {
      ...
      private function onFaqText(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            var_29.tellUI(HabboHelpViewEnum.const_193,_loc4_);
         }
      }
      ...
      private function onFaqCategory(param1:IMessageEvent) : void
      {
         ...
         var_29.tellUI(HabboHelpViewEnum.const_252,_loc6_);
      }
      ...
      private function onFaqClientFaqs(param1:IMessageEvent) : void
      {
         ...
         var_29.tellUI(HabboHelpViewEnum.const_132);
      }
      ...
      {
         var_29.showUI(HabboHelpViewEnum.const_315);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         var_29.showUI(HabboHelpViewEnum.const_362);
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         var_29.showUI(HabboHelpViewEnum.const_565);
         var_29.tellUI(HabboHelpViewEnum.const_565,_loc5_);
      }
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            if(_loc5_.webID != _userId && _loc5_.userType == RoomObjectTypeEnum.const_429)
            {
         ...
         var_29.tellUI(HabboHelpViewEnum.const_726);
      }
