package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_2075:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","25228-25217-201003051538");
         var_188 = param5;
         var_106 = new Map();
         var_106.add(HabboHelpViewEnum.const_1258,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_106.add(HabboHelpViewEnum.const_132,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_106.add(HabboHelpViewEnum.const_362,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_106.add(HabboHelpViewEnum.const_252,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_106.add(HabboHelpViewEnum.const_193,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_106.add(HabboHelpViewEnum.const_565,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_106.add(HabboHelpViewEnum.const_315,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_106.add(HabboHelpViewEnum.const_570,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_106.add(HabboHelpViewEnum.const_201,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         ...
         var_106.add(HabboHelpViewEnum.const_875,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_263 == HabboHelpViewEnum.const_132 || false)
         {
            return;
         }
         if(var_411 == null)
      ...
      {
         var_2074 = param1;
         var _loc2_:IHelpViewController = var_106.getValue(HabboHelpViewEnum.const_132) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            ...
            case CallForHelpResultEnum.const_998:
               showUI(HabboHelpViewEnum.const_875);
               break;
            case CallForHelpResultEnum.const_999:
      ...
      {
         var _loc3_:* = null;
         if(var_263 == HabboHelpViewEnum.const_132)
         {
            return;
         }
         if(true)
         {
            ...
            var_585.push(_loc3_.content as BitmapData);
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(var_585[1],var_585[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(var_585[0],var_585[0].rect,new Point(0,0));
         }
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.height = _loc1_.height + var_1532;
         _window.width = _loc1_.width + var_1533;
      }
