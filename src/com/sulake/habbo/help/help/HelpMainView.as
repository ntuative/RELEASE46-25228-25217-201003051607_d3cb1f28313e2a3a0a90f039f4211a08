package com.sulake.habbo.help.help
{
   ...
   public class HelpMainView extends SearchViewController implements IHelpViewController
   {
      ...
      private static const const_1122:int = 60;
      ...
      override public function windowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "help_faq_browse":
               main.showUI(HabboHelpViewEnum.const_362);
               break;
            case "help_habboway":
            ...
            case "help_cfh":
               ...
               main.showUI(HabboHelpViewEnum.const_315);
               break;
      ...
      override public function render() : void
      {
         ...
         if(_loc1_ == null || _loc1_.getFrontPageUrgentCategory().getAgeSeconds() > const_1122)
         {
      ...
      private function method_3(param1:IWindow) : void
      {
         ...
         if(_loc6_ != null)
         {
            ...
            main.tellUI(HabboHelpViewEnum.const_193,_loc6_);
         }
      }
   }
}
