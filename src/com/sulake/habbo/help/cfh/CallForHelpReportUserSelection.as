package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpReportUserSelection extends HelpViewController
   {
      ...
      override public function update(param1:* = null) : void
      {
         ...
         var_553 = main.component.userRegistry.getRegistry();
         if(false)
         {
         ...
         var i:int = 0;
         while(i < var_553.length)
         {
            u = var_553.getWithIndex(i);
      ...
      private function method_3(param1:IWindow) : void
      {
         ...
         if(_loc3_ < 0 || _loc3_ > var_553.length)
         {
            return;
         }
         var _loc4_:UserRegistryItem = var_553.getWithIndex(_loc3_);
         if(_loc4_ == null)
         {
            return;
         }
