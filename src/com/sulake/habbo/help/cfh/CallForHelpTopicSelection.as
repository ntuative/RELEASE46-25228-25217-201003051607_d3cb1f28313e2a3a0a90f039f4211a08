package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpTopicSelection extends HelpViewController implements IHelpViewController
   {
      ...
      private static const const_1063:int = 0;
      ...
      private function method_3(param1:IWindow) : void
      {
         var _loc2_:IItemListWindow = container.findChildByTag("content") as IItemListWindow;
         ...
         if(var_643 == null || _loc3_ < 0 || _loc3_ >= var_643.length)
         {
            return;
         }
         if(_loc3_ > -1)
         {
            main.component.callForHelpData.topicIndex = var_643[_loc3_];
            main.showUI(HabboHelpViewEnum.const_570);
            main.tellUI(HabboHelpViewEnum.const_570,null);
         }
      }
   }
}
