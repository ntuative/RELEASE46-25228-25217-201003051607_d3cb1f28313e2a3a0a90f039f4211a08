package com.sulake.habbo.communication.messages.parser.room.engine
{
   ...
   public class UsersMessageParser implements IMessageParser
   {
      ...
      public function parse(param1:IMessageDataWrapper) : Boolean
      {
         ...
         while(_loc3_ < _loc2_)
         {
            ...
            if(_loc13_ == 1)
            {
               ...
               _loc14_.userType = RoomObjectTypeEnum.const_429;
            ...
            {
               _loc14_.userType = RoomObjectTypeEnum.const_919;
               ...
               _loc14_.sex = UserMessageData.const_989;
            }
            _loc3_++;
         }
         return true;
      ...
      private function resolveSex(param1:String) : String
      {
         ...
         {
            return UserMessageData.const_1248;
         }
         return UserMessageData.const_989;
      }
