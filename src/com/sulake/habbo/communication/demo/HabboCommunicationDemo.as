package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_1428:ILogger;
      
      private var var_1153:String;
      
      private var var_1743:String;
      
      private const const_1401:String = "fuselogin";
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         switch(_loc2_)
         {
            case DisconnectReasonEvent.const_333:
               _loc3_ = var_97.getKey("logout.banned.url");
               break;
            case DisconnectReasonEvent.const_945:
               _loc3_ = var_97.getKey("logout.concurrent.url");
               break;
            case DisconnectReasonEvent.const_966:
               _loc3_ = var_97.getKey("logout.url");
               break;
            case DisconnectReasonEvent.const_921:
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_1744)
         {
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1153,var_1743));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1401,"/");
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_1742);
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1401,"/");
      ...
      {
         var_647 = var_97.getKey("sso.ticket",null);
         var_1153 = var_97.getKey("flash.client.url","");
         var_1743 = var_97.getKey("external.variables.txt","");
         if(var_166 == null)
         {
         ...
         if(var_647 != null)
         {
            var_70.mode = HabboConnectionType.const_348;
            var_70.initConnection(HabboConnectionType.const_234);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1428 = param2 as ILogger;
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_525);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_1742 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_70.mode)
         {
            case HabboConnectionType.const_348:
               ...
               var_955 = _loc4_;
               var_166.loadBannerImage(_loc7_ + "?token=" + var_955,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1322:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1161:
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_955);
         ...
         while(_loc13_ > 0)
         {
            var_956 = generateRandomHexString(30);
            var_457.init(var_956);
            _loc14_ = var_457.getPublicKey(10);
            if(_loc14_.length >= 64)
            {
               _loc12_ = _loc14_;
            }
            if(_loc12_ == null || _loc14_.length > _loc12_.length)
            {
               _loc12_ = _loc14_;
            }
            _loc13_--;
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            Component(var_97).events.addEventListener(HabboConfigurationEvent.const_155,onConfigurationLoaded);
         }
      }
