package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_335.shockwaveClientUrl = var_111.shockwaveClientUrl;
         var_335.ssoTicket = var_111.ticket;
         var_111.removeEventListener(SSOTicket.const_294,onParsedTicketSuccess);
         var_111.removeEventListener(SSOTicket.const_239,onParsedTicketFailure);
         var_111 = null;
      ...
      private function windowEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(const_1401,"/");
      ...
      private function createWindow() : void
      {
         ...
         _window = var_335.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_371,HabboWindowStyle.const_39,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(const_1401,"/");
         if(_loc5_ != null)
         {
      ...
      private function initSSOTicket() : void
      {
         ...
         var_111 = new SSOTicket(var_335.assets,_loc2_,_loc1_);
         var_111.addEventListener(SSOTicket.const_294,onParsedTicketSuccess);
         var_111.addEventListener(SSOTicket.const_239,onParsedTicketFailure);
      }
