package com.sulake.habbo.communication.protocol
{
   ...
   public class WedgieProtocol implements IProtocol
   {
      ...
      public static const const_1216:uint = 1;
      
      public static const const_1186:uint = 2;
       
      
      private var var_764:IProtocolDecoder;
      
      private var var_941:IProtocolEncoder;
      
      public function WedgieProtocol()
      {
         super();
         var_941 = new WedgieEncoder();
         var_764 = new WedgieDecoder();
      }
      ...
      public function getMessages(param1:ByteArray, param2:Array) : uint
      {
         ...
         while(param1.bytesAvailable)
         {
            ...
            if(_loc5_ == const_1216)
            {
               _loc4_.position = 0;
               _loc6_ = var_764.getID(_loc4_);
