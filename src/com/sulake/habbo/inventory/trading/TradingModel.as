package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_173:uint = 1;
      
      public static const const_151:uint = 0;
      
      public static const const_1369:uint = 9;
      ...
      public function updateItemGroupMaps(param1:int, param2:Map, param3:int, param4:Map) : void
      {
         ...
         var_496 = false;
         var_695 = false;
         var_46.updateItemList(var_694);
         var_46.updateItemList(var_1268);
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         else if(param1 is TradingAcceptEvent)
         {
            ...
            if(TradingAcceptEvent(param1).userID == var_694)
            {
               var_496 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               var_695 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            var_46.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != var_694)
            {
               var_46.alertPopup(TradingView.const_1013);
            }
            close();
         }
      ...
      {
         Logger.log("OLD STATE: " + var_34 + " NEW STATE: " + param1 + " OWN: " + var_496 + " OTHER: " + var_695);
         ...
         {
            case const_151:
               if(param1 == const_173 || param1 == const_222)
               {
                  var_34 = param1;
                  _loc2_ = true;
               }
      ...
      public function close() : void
      {
         if(var_569)
         {
            if(var_34 != const_151 && var_34 != const_222)
            {
               requestCancelTrading();
               state = TradingModel.TRADING_STATE_CANCELLED;
            }
            state = const_151;
            var_8.toggleInventorySubPage(InventorySubCategory.const_1003);
            var_569 = false;
         }
         var_46.setMinimized(false);
      }
