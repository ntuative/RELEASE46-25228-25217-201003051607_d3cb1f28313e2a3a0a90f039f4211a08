package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      private static const const_1129:int = 100;
      
      public static const const_303:String = "pets";
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboLocalizationManager, param8:IHabboConfigurationManager)
      {
         ...
         var_511 = new Timer(const_1129,1);
      ...
      {
         return var_10.getSubCategoryViewId() == InventorySubCategory.const_249;
      }
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = var_427.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = var_427.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(param3 == FurniCategory.const_283)
         {
         ...
         else if(param3 == FurniCategory.const_298)
         {
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_249:
               ...
               break;
            case InventorySubCategory.const_1003:
               removeAllLocks();
               if(_view != null)
               {
                  _view.updateActionView();
      ...
      {
         var_10.checkCategoryInitilization(InventoryCategory.const_452);
         ...
         if(param1 == InventoryCategory.const_69 && false)
         {
            switch(_view.visibleCategoryId)
            {
               ...
               case const_41:
                  ...
                  break;
               case const_303:
                  var_10.toggleInventoryPage(InventoryCategory.const_165);
            }
         }
      }
      ...
      {
         if(var_911 && param1.type == RoomEngineObjectEvent.const_208)
         {
            var_10.showView();
            var_911 = false;
         }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_329 || _loc3_.category == FurniCategory.const_283 || _loc3_.category == FurniCategory.const_298)
         {
            if(param1)
            {
               return false;
      ...
      {
         return var_427.getValue(param1);
      }
      
      public function clearFurniList() : void
      {
         var_427 = new Map();
         var_427.add(const_40,new Array());
         var_427.add(const_41,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }
