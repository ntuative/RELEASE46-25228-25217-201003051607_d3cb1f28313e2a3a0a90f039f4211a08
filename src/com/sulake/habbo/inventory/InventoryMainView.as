package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         _loc2_.container.removeChild(var_1274);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(var_697 == InventoryCategory.const_165)
            {
               toggleCategoryView(InventoryCategory.const_165);
            }
            else if(var_697 == InventoryCategory.const_69)
            {
      ...
      public function setHabboToolbarIcon() : void
      {
         if(var_188 != null)
         {
            var_188.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_124,HabboToolbarIconEnum.INVENTORY));
         }
      }
      ...
      private function setSubViewToCategory(param1:String) : void
      {
         ...
         if(var_188 != null)
         {
            var_188.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_698,HabboToolbarIconEnum.INVENTORY,var_12 as IWindowContainer));
         }
      }
      ...
      public function showInventory() : void
      {
         ...
         var_10.inventoryViewOpened(var_698);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true) : void
      {
         ...
         else
         {
            _loc3_.visible = true;
            _loc3_.activate();
            if(param1 != var_697 || !var_10.isInventoryCategoryInit(param1))
            {
               setViewToCategory(param1);
            }
            if(var_188 != null && var_865)
