package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_784:IRoomSession;
      ...
      override public function dispose() : void
      {
         ...
         if(var_19 != null)
         {
            var_19.events.removeEventListener(RoomSessionEvent.const_93,roomSessionEventHandler);
            var_19.events.removeEventListener(RoomSessionEvent.const_101,roomSessionEventHandler);
            var_19.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_478,roomSessionEventHandler);
      ...
      {
         return EffectsModel(var_45.getValue(InventoryCategory.const_656));
      }
      ...
      {
         var_151.clubPeriods = param1;
         var_151.clubDays = param2;
         var_151.clubHasEverBeenMember = param3;
      ...
      {
         return PetsModel(var_45.getValue(InventoryCategory.const_165));
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_913));
      }
      ...
      {
         return AchievementsModel(var_45.getValue(InventoryCategory.const_320));
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_783.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_783.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return TradingModel(var_45.getValue(InventorySubCategory.const_249));
      }
      
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_325 = ISessionDataManager(param2);
         queueInterface(new IIDHabboConfigurationManager(),onConfigurationManagerReady);
      }
      
      public function isInventoryCategoryInit(param1:String) : Boolean
      {
         if(var_783.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      {
         return var_151.creditBalance;
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return var_45.getValue(InventoryCategory.const_452) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_959 = new IncomingMessages(this);
      ...
      {
         return var_151.clubHasEverBeenMember;
      }
      
      public function get clubPastPeriods() : int
      {
         return var_151.clubPastPeriods;
      }
      ...
      {
         return BadgesModel(var_45.getValue(InventoryCategory.const_270));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_19.events.addEventListener(RoomSessionEvent.const_93,roomSessionEventHandler);
         var_19.events.addEventListener(RoomSessionEvent.const_101,roomSessionEventHandler);
         var_19.events.addEventListener(RoomSessionPropertyUpdateEvent.const_478,roomSessionEventHandler);
         ...
         var_45.add(InventoryCategory.const_452,_loc3_);
         ...
         var _loc5_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_325);
         var_45.add(InventoryCategory.const_270,_loc5_);
         var _loc6_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_45.add(InventoryCategory.const_656,_loc6_);
         var _loc7_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_325);
         var_45.add(InventoryCategory.const_320,_loc7_);
         var _loc8_:TradingModel = new TradingModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_45.add(InventorySubCategory.const_249,_loc8_);
         ...
         var_45.add(InventoryCategory.const_165,_loc10_);
