package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1002:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         var_94 = var_575.height;
         var_1003 = param5;
         var_846 = param6;
         var_225 = Math.floor(var_1003 / _thumbWidth);
         var_17 = new BitmapData(var_1003,var_846);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(param1.y < var_479 - 1)
         {
            ...
            var_17.fillRect(new Rectangle(0,0 - var_94,var_17.width,var_94),4294967295);
         ...
         if(_loc6_ > 0)
         {
            ...
            {
               _loc11_ = new BitmapData(var_17.width,0 - var_94);
               _loc2_ = new Rectangle(0,0,var_17.width,0 - var_94);
               _loc11_.copyPixels(var_17,_loc2_,new Point(0,0),null,null,true);
               var_17 = _loc11_;
               --var_479;
            }
         }
         if(var_17.height < var_846)
         {
            _loc12_ = new BitmapData(var_17.width,var_846);
      ...
      private function getList() : Array
      {
         ...
         if(var_1002 != null)
         {
            _loc1_ = var_1002.getDrawableList();
         }
      ...
      public function updateImageFromList() : void
      {
         ...
         var_17 = new BitmapData(Math.max(var_225 * _thumbWidth,var_1003),Math.max(var_479 * var_94,var_846),true,16777215);
            ...
            while(_loc4_ < var_225)
            {
               if(_loc1_ < _loc2_.length)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     var_17.copyPixels(_loc6_,_loc6_.rect,new Point(_loc4_ * _thumbWidth,_loc3_ * var_94),null,null,true);
                  }
                  _loc1_++;
               }
               _loc4_++;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_225 && var_17.height < _loc3_.y * var_94)
         {
            _loc2_ = new BitmapData(var_17.width,var_17.height + var_94);
         }
         else
         {
         ...
         _loc4_ = new Rectangle(_thumbWidth * (var_225 - 1),0,_thumbWidth,var_17.height);
         _loc2_.copyPixels(var_17,_loc4_,new Point(0,var_94),null,null,true);
         _loc4_ = new Rectangle(0,var_94,_thumbWidth * (var_225 - 1),0 - var_94);
         _loc2_.copyPixels(var_17,_loc4_,new Point(_thumbWidth,var_94),null,null,true);
         var_17 = _loc2_;
      }
