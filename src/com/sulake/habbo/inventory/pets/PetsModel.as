package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(var_1193 && param1.type == RoomEngineObjectEvent.const_208)
         {
            var_10.showView();
            var_1193 = false;
         }
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            var_1193 = _roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_34,RoomObjectTypeEnum.const_321,_loc3_.figure);
            var_10.closeView();
            return;
         }
      ...
      {
         if(var_985.add(param1.id,param1))
         {
            _view.addPet(param1);
         }
      }
