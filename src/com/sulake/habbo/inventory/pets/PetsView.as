package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView
   {
      ...
      {
         if(var_572 == null || false)
         {
            updatePreview();
            return;
         }
         setSelectedGridItem(var_572.getWithIndex(0));
      }
      ...
      {
         var _loc2_:PetsGridItem = var_572.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(var_572.getValue(param1.id) != null)
         {
            return;
         }
