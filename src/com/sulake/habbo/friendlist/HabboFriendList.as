package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_1434:OpenedToWebPopup;
      
      private var var_791:IAvatarRenderManager;
      ...
      private var var_1435:AvatarSearchResults;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_790:FriendRequests;
      
      private var var_1727:int;
      
      var var_13:FriendCategories;
      
      private var var_1782:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_789:IHabboNotifications;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         var_1782 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_13 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1435 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_790.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_790.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_385.findTab(FriendListTab.const_81).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_790 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_13.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_13.addCategory(new FriendCategory(FriendCategory.const_935,getText("friendlist.friends")));
         var_13.addCategory(new FriendCategory(FriendCategory.const_411,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_13.addFriend(new Friend(_loc4_));
         }
         var_385 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!var_461)
         {
            var_461 = new Timer(120000);
            var_461.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_461.start();
         }
         getBuddyRequests();
         registerListeners();
         var_188.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_124,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         {
            var_461.stop();
            var_461.removeEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_461 = null;
         }
         if(_windowManager)
         {
         ...
         if(var_791)
         {
            var_791.release(new IIDAvatarRenderManager());
            var_791 = null;
         }
         if(var_789)
         {
            var_789.release(new IIDHabboNotifications());
            var_789 = null;
         }
         if(var_188)
         {
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_385.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_325));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1435.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(var_790.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      {
         var _loc2_:FriendListTab = var_385.findTab(FriendListTab.const_81);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_791.createAvatarImage(param1,AvatarScaleType.const_95);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_790.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_385.findTab(FriendListTab.const_81);
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_791 = param2 as IAvatarRenderManager;
      ...
      {
         var_789 = param2 as IHabboNotifications;
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1434 == null)
         {
            var_1434 = new OpenedToWebPopup(this);
         }
         var_1434.show(x,y);
      }
