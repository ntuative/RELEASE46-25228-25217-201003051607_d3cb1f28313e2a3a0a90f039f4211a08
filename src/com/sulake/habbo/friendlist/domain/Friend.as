package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1556:int = "F".charCodeAt(0);
      
      public static const const_1580:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         _id = param1.id;
         _name = param1.name;
         var_984 = param1.gender;
         var_677 = param1.online;
         var_1139 = param1.followingAllowed && param1.online;
         var_556 = param1.figure;
         var_1141 = param1.motto;
         var_1140 = param1.lastAccess;
         var_1138 = param1.categoryId;
