package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      {
         return Math.ceil(this.var_211.length / const_280);
      }
      ...
      {
         if(this.var_756 >= this.getPageCount())
         {
            this.var_756 = Math.max(0,this.getPageCount() - 1);
         }
      }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_756 + 1) * const_280,this.var_211.length);
      }
