package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1410:String = "noconvinfo";
      ...
      private var var_1238:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         super();
         _friendList = param1;
         var_1238 = new FriendListTabsView(_friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         var_842 = IWindowContainer(var_12.content.findChildByName("main_content"));
         var_279 = IWindowContainer(var_12.content.findChildByName("footer"));
         var_1238.prepare(var_842);
         var_12.procedure = onWindow;
         var_12.content.setParamFlag(HabboWindowParam.const_790,false);
         var_12.content.setParamFlag(HabboWindowParam.const_1331,true);
         var_12.header.setParamFlag(HabboWindowParam.const_523,false);
         var_12.header.setParamFlag(HabboWindowParam.const_819,true);
         var_12.content.setParamFlag(HabboWindowParam.const_523,false);
         var_12.content.setParamFlag(HabboWindowParam.const_819,true);
         var_12.findChildByName("open_edit_ctgs_but").procedure = onEditCategoriesButtonClick;
         var_1237 = ITextWindow(var_12.findChildByName("info_text"));
         var_1237.text = "";
      ...
      private function refreshWindowSize() : void
      {
         ...
         var_279.y = Util.getLowestPoint(var_12.content);
         ...
         var_12.scaler.setParamFlag(HabboWindowParam.const_940,this._friendList.tabs.findSelectedTab() != null);
         var_12.scaler.setParamFlag(HabboWindowParam.const_523,false);
         var_12.scaler.setParamFlag(HabboWindowParam.const_790,false);
         var_12.scaler.x = 0 - var_12.scaler.width;
         var_12.scaler.y = 0 - var_12.scaler.height;
         var_1501 = var_12.height;
         var_1500 = var_12.width;
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = var_1501 == -1 ? 0 : int(0 - var_1501);
         var _loc4_:int = var_1500 == -1 ? 0 : int(0 - var_1500);
