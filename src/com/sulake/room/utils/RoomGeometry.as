package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         _y = new Vector3d();
         var_87 = new Vector3d();
         var_1006 = new Vector3d();
         var_1507 = 1;
         var_1508 = 1;
         x_scale = 1;
         y_scale = 1;
         var_1506 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      {
         if(var_405 != param1 * var_1506)
         {
            var_405 = param1 * var_1506;
            ++var_79;
         }
      }
      ...
      {
         if(var_403 != param1 * var_1507)
         {
            var_403 = param1 * var_1507;
            ++var_79;
         }
      }
      ...
      {
         if(var_404 != param1 * var_1508)
         {
            var_404 = param1 * var_1508;
            ++var_79;
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(var_402 != null)
         {
            ...
            var_402.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            var_402.add(_loc3_,_loc4_);
            ++var_79;
         }
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_1006.assign(_loc22_);
         }
         else
         {
            var_1006.assign(_loc17_);
         }
         ++var_79;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= var_404;
         _loc2_.z *= var_405;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_1006);
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= var_404;
            _loc2_.z *= var_405;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_1006);
         }
      ...
      {
         return new Vector3d(0 * var_403,0 * var_404,0 * var_405);
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(var_402 != null)
         {
            ...
            return var_402.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(0 * var_403,0 * var_404,0 * var_405);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_87;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_403,param2.y * var_404,param2.z * var_405);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_403,param3.y * var_404,param3.z * var_405);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_403,param4.y * var_404,param4.z * var_405);
