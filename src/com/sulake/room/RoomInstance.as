package com.sulake.room
{
   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      protected function disposeObjectManager(param1:int) : Boolean
      {
         ...
         if(var_217.getValue(_loc2_) != null)
         {
            _loc3_ = var_217.remove(_loc2_) as IRoomObjectManager;
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = 0;
            while(_loc2_ < var_217.length)
            {
               _loc3_ = var_217.getWithIndex(_loc2_) as IRoomObjectManager;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      public function disposeObject(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc4_ != null)
            {
               if(var_124)
               {
                  var_124.removeRoomObject(_loc4_.getInstanceId());
               }
      ...
      protected function createObjectManager(param1:int) : IRoomObjectManager
      {
         ...
         if(var_217.getValue(_loc2_) != null)
         {
            return var_217.getValue(_loc2_) as IRoomObjectManager;
         }
         if(_container == null)
         {
            return null;
      ...
      {
         return var_217.getKeys();
      }
      
      protected function getObjectManager(param1:int) : IRoomObjectManager
      {
         return var_217.getValue(String(param1)) as IRoomObjectManager;
      }
         ...
         if(_loc3_ != null)
         {
            ...
            while(_loc4_ < _loc2_)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(var_124)
                  {
                     var_124.removeRoomObject(_loc6_);
                  }
               }
               _loc4_++;
            }
