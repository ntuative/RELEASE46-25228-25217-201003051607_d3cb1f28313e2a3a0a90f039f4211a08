package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private var var_2161:Number = -10000000;
      
      private var var_2163:Number = -10000000;
      
      private var var_2340:int = 0;
      
      private var var_507:RoomObjectCache;
      
      private var var_725:int;
      
      private var var_274:Sprite;
      
      private var var_1072:IRoomRenderingCanvasMouseListener = null;
      ...
      public function update() : void
      {
         if(var_1073 == 0)
         {
            checkMouseHits(var_1074.x,var_1074.y,MouseEvent.MOUSE_MOVE);
         }
         var_1073 = 0;
         ++var_1565;
      }
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         var_53.graphics.beginFill(var_2340);
      ...
      {
         var _loc11_:Number = param1 - var_725 / 2;
      ...
      public function render(param1:int) : void
      {
         ...
         if(var_725 != var_2162 || var_723 != var_2159)
         {
            _loc10_ = true;
         }
         _loc5_ = 0;
         ...
         var_724.push(_loc12_ - _loc2_);
         if(var_724.length == const_780)
         {
            _loc13_ = 0;
            _loc14_ = 0;
            while(_loc14_ < const_780)
            {
               _loc13_ += var_724[_loc14_];
               _loc14_++;
            }
         ...
         while(_loc1_ < var_310.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  if(var_1072 != null)
                  {
                     var_1072.processRoomCanvasMouseEvent(_loc3_,_loc4_,_id + var_1565,geometry);
                  }
                  else
                  {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK || !_loc10_.clickHandling)
               {
                  ...
                  if(_loc12_.indexOf(_loc9_) < 0)
                  {
                     ...
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != var_2161 || param2 != var_2163)
                     {
                        bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean) : int
      {
         ...
         if(_loc5_ == null)
         {
            var_507.removeObjectCache(param2);
            return 0;
         }
         var _loc6_:RoomObjectCacheItem = var_507.getObjectCache(param2);
         ...
         while(_loc21_ < _loc11_)
         {
            ...
            if(_loc17_ != null && _loc17_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  ...
                  if(_loc18_ + _loc22_.width >= 0 && _loc18_ < var_725 && (_loc19_ + _loc22_.height >= 0 && _loc19_ < var_723))
                  {
