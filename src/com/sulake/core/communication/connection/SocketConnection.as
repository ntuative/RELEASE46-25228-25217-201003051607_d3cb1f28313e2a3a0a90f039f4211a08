package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1307:int = 10000;
      ...
      private var var_623:IEncryption;
      
      private var var_624:int;
      
      private var var_324:ByteArray;
      ...
      private var var_323:IConnectionStateListener;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         _id = param1;
         var_306 = param2;
         var_324 = new ByteArray();
         var_752 = new MessageClassManager();
         var_76 = new Socket();
         var_322 = new Timer(const_1307,1);
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         if(var_323)
         {
            var_323.messageSent(String(_loc4_),_loc5_.toString());
         }
         if(var_623 != null)
         {
            _loc3_ = var_623.encipher(_loc5_);
         }
         else
         {
            _loc3_ = _loc5_;
      ...
      public function init(param1:String, param2:uint = 0) : Boolean
      {
         if(var_323)
         {
            var_323.connectionInit(param1,param2);
         }
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         while(false)
         {
            var_324.writeByte(var_76.readUnsignedByte());
         }
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var _loc2_:uint = var_535.getMessages(var_324,_loc1_);
         ...
         for each(_loc4_ in _loc1_)
         {
            ...
            if(var_323)
            {
               var_323.messageReceived(String(_loc5_),_loc6_.toString());
            }
         ...
         else if(_loc2_ > 0)
         {
            ...
            _loc18_.writeBytes(var_324,_loc2_);
            var_324 = _loc18_;
         }
      }
      ...
      override public function toString() : String
      {
         ...
         return _loc1_ + ("Encryption: " + var_623 + "\n");
      }
   }
}
