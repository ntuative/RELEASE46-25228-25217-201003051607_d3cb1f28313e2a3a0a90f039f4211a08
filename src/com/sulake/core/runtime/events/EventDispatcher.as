package com.sulake.core.runtime.events
{
   ...
   public class EventDispatcher implements IEventDispatcher, IDisposable
   {
      ...
      public function dispatchEvent(param1:Event) : Boolean
      {
         if(!_disposed)
         {
            ...
            if(_result == const_782)
            {
               if(var_729 != null)
               {
                  Core.crash("Error catched in EventDispatcher: undefined",var_729.errorID,var_729);
               }
               else
               {
                  Core.crash("Error catched in EventDispatcher. No error data available!",0,var_729);
               }
            }
      ...
      private function eventProcessor(param1:Event) : void
      {
         ...
         _result = !!event.isDefaultPrevented() ? uint(const_1126) : uint(const_494);
      }
