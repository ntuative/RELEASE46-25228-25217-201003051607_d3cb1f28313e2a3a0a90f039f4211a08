package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_1568:uint = 1;
      
      public static const COMPONENT_EVENT_DEBUG:String = "COMPONENT_EVENT_DEBUG";
      
      public static const const_975:uint = 4;
      ...
      protected var var_1964:Boolean = false;
      ...
      public function release(param1:IID) : uint
      {
         ...
         if(_loc2_ == null)
         {
            var_933 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(var_933);
         }
         var _loc3_:uint = _loc2_.release();
         if(var_1097 & const_975)
         {
            if(_loc3_ == 0)
            {
