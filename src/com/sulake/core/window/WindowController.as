package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_115,WindowParam.const_139);
         var _loc2_:* = !testParamFlag(WindowParam.const_111,WindowParam.const_140);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_5.clone();
            if(_loc1_)
            ...
            if(_loc2_)
            {
               _loc4_ = 0 - 0;
               _loc5_ = uint(var_15 & 0);
               if(_loc5_ == WindowParam.const_230)
               {
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_2158 + "]";
      }
      ...
      protected function forwardWindowNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_985:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1286:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1343:
               _loc2_ = "null";
               break;
      ...
      public function setStyleFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_81 != _loc3_)
         {
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_383,this,null));
         }
      }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_16)
         {
            var_16 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_639,var_5);
      ...
      {
         var_370 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         _context.invalidate(this,var_5,WindowRedrawFlag.const_827);
      }
      ...
      {
         return testLocalPointHitAgainstAlpha(param1,param2,var_745);
      }
         ...
         if(param2 is MouseEvent)
         {
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_807;
                  if(testParamFlag(WindowParam.const_284))
                  {
                     _loc5_ = {};
                     while(_loc5_ != null)
                     {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_220:
                  ...
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_437,this,null));
                     if(testParamFlag(WindowParam.const_152,WindowParam.const_139))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_159,WindowParam.const_140))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_6 != null)
               ...
               case WindowNotifyEvent.const_369:
                  ...
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_1008,this,null));
                     if(var_6 != null)
                     {
                        var_6.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_267,var_6,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_331:
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_598,this,null));
                     if(var_6 != null)
                     {
                  ...
                  break;
               case WindowNotifyEvent.const_373:
                  _context.invalidate(this,var_5,WindowRedrawFlag.const_830);
                  break;
               case WindowNotifyEvent.const_383:
                  _loc6_ = new Array();
               ...
               case WindowNotifyEvent.const_226:
                  ...
                  break;
               case WindowNotifyEvent.const_437:
                  var_6.getRegionProperties(null,var_309);
                  updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_317:
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return testLocalPointHitAgainstAlpha(_loc3_,param2,var_745);
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            else if(_loc7_ == WindowParam.const_352)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
            ...
            else if(_loc7_ == WindowParam.const_469)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            ...
            if(_loc6_)
            {
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_220,this,null));
            }
         }
      }
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1252,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         setStateFlag(WindowState.const_59,true);
         _loc1_.type = WindowNotifyEvent.const_1177;
         update(this,_loc1_);
         return true;
      }
         ...
         if(var_162 && var_745 > 0)
         {
            if(!testParamFlag(WindowParam.const_29))
            {
               if(param1.x <= var_5.width && param1.y <= var_5.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1564,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1564,param3,param1)) : false;
            }
         }
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1330,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         setStateFlag(WindowState.const_59,false);
         _loc1_.type = WindowNotifyEvent.const_1256;
         update(this,_loc1_);
         return true;
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_6 != param1)
         {
            ...
            if(var_6 != null)
            {
               var_309 = var_6.rectangle.clone();
               var_54.x = var_5.x;
               var_54.y = var_5.y;
               var_54.width = var_5.width;
               var_54.height = var_5.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_451,this,var_6));
            }
            else
            {
               var_309.x = 0;
               ...
               var_309.width = 0;
               var_309.height = 0;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_1016,this,_loc2_));
            }
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_81,var_15,_context,var_5,null,var_616,properties,var_614.concat(),_id) as WindowController;
      ...
      protected function forwardMouseEvent(param1:MouseEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               ...
               break;
            case MouseEvent.MOUSE_UP:
               _loc2_ = !!_loc6_ ? "null" : WindowMouseEvent.const_444;
               break;
            case MouseEvent.MOUSE_WHEEL:
               _loc2_ = "null";
         }
      ...
      {
         var_745 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      {
         if(var_34 == WindowState.const_428)
         {
            return true;
         }
         var_34 = WindowState.const_428;
