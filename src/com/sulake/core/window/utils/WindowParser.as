package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1592:String = "_INCLUDE";
      
      public static const const_895:String = "_EXCLUDE";
      
      public static const const_1590:String = "_TEMP";
      ...
      protected var var_1093:Dictionary;
      
      private var _disposed:Boolean = false;
      
      protected var var_921:Dictionary;
      
      protected var var_1360:Map;
      
      protected var _context:IWindowContext;
      
      protected var var_1359:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(var_1094,var_1093);
         var_921 = new Dictionary();
         var_1359 = new Dictionary();
         ParamCodeTable.fillTables(var_921,var_1359);
         var_1360 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1029,"");
         return param1.replace(const_1030,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            ...
            for(_loc1_ in var_1093)
            {
               delete var_1093[_loc1_];
            }
            for(_loc1_ in var_921)
            {
               delete var_921[_loc1_];
            }
            for(_loc1_ in var_1359)
            {
               delete var_1359[_loc1_];
            }
            var_1360.dispose();
            var_1360 = null;
            _context = null;
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_895) == -1)
                  {
