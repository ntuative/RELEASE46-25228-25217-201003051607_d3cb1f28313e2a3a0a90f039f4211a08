package com.sulake.core.window.utils
{
   ...
   public class PropertyStruct
   {
      ...
      public static const const_533:String = "Number";
      
      public static const const_61:String = "int";
      
      public static const STRING:String = "String";
      
      public static const const_669:String = "Point";
      
      public static const const_1015:String = "Array";
      
      public static const const_881:String = "uint";
      
      public static const const_481:String = "hex";
      
      public static const const_947:String = "Map";
      ...
      public function PropertyStruct(param1:String, param2:Object, param3:String, param4:Boolean)
      {
         ...
         _type = param3;
         var_2137 = param4;
         var_2315 = param3 == const_947 || param3 == const_1015 || param3 == const_669 || param3 == const_693;
      }
      ...
      public function toString() : String
      {
         switch(_type)
         {
            ...
            case const_56:
               return Boolean(var_174) == true ? "true" : "PetPlacingErrorParser";
            case const_669:
      ...
      public function toXMLString() : String
      {
         ...
         switch(_type)
         {
            ...
            case const_693:
               ...
               break;
            case const_481:
               _loc1_ = "<var key=\"" + var_597 + "\" value=\"" + "0x" + uint(var_174).toString(16) + "\" type=\"" + _type + "\" />";
               break;
            default:
               _loc1_ = "<var key=\"" + var_597 + "\" value=\"" + var_174 + "\" type=\"" + _type + "\" />";
         }
         return _loc1_;
      }
