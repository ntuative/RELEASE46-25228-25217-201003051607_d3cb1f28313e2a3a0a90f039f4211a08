package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1042:uint = 8;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         var_1400 = new Dictionary();
         var_1635 = new Dictionary();
         TypeCodeTable.fillTables(var_1400,var_1635);
         var_1120 = new Dictionary();
         var_1636 = new Dictionary();
         StateCodeTable.fillTables(var_1120,var_1636);
         var_440 = new Dictionary();
         var_440["skin"] = BitmapSkinRenderer;
         var_440["bitmap"] = BitmapDataRenderer;
         var_440["fill"] = FillSkinRenderer;
         var_440["text"] = TextSkinRenderer;
         var_440["shape"] = ShapeSkinRenderer;
         var_440["unknown"] = SkinRenderer;
         var_440["null"] = NullSkinRenderer;
         if(var_366 == null)
         {
            var_366 = new Array();
            ...
            var_366.push(WindowState.const_70);
            var_366.push(WindowState.const_92);
            var_366.push(WindowState.const_82);
         }
         var _loc3_:Array = new Array();
         for(_loc4_ in var_1120)
         {
            _loc3_.push(var_1120[_loc4_]);
         }
         if(param1 != null)
         {
            ...
            if(_loc6_ > 0)
            {
               ...
               while(_loc18_ < _loc6_)
               {
                  ...
                  addSkinRenderer(var_1400[_loc9_],uint(_loc10_),_loc15_);
                  _loc18_++;
               }
            }
         }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer) : void
      {
         if(true)
         {
            var_541[param1] = new Array(SkinContainer.const_1042);
         }
