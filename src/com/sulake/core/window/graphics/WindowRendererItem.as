package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private var var_634:ISkinContainer;
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.const_830:
               var_635 = var_634.getTheActualState(param1.type,param1.style,param1.state);
               if(var_635 != var_942)
               {
                  var_214 = true;
                  _loc4_ = true;
               ...
               break;
            case WindowRedrawFlag.const_827:
               if(param1.testParamFlag(WindowParam.const_29))
               {
                  var_214 = true;
                  _loc4_ = true;
      ...
      {
         return var_634.getTheActualState(param1.type,param1.style,param1.state) != var_942;
      }
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         var _loc4_:* = null;
         var _loc10_:* = 0;
         var _loc5_:uint = !!param1.background ? uint(const_746) : uint(const_485);
         var _loc6_:ISkinRenderer = resolveSkinRenderer(param1);
         if(_loc6_ != null)
         {
            _loc5_ = !!_loc6_.isStateDrawable(var_635) ? uint(const_747) : uint(_loc5_);
         }
         ...
         if(_loc5_ != const_485)
         {
            if(var_91 == null)
            {
               var_91 = _drawBufferAllocator.allocate(_loc7_,_loc8_,true,param1.color);
               var_214 = true;
            }
            else if(var_91.width != _loc7_ || var_91.height != _loc8_)
            {
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc5_ == const_747)
               {
                  ...
                  if(var_214)
                  {
                     ...
                     _loc6_.draw(param1,var_91,var_91.rect,var_635,false);
                     if(!param1.background)
                     {
                        _loc10_ = uint(param1.color);
                        if((_loc10_ & 16777215) < 16777215)
                        {
                           var_91.colorTransform(_loc4_.rect,new ColorTransform(((_loc10_ & 16711680) >> 16) / 255,((_loc10_ & 65280) >> 8) / 255,(_loc10_ & 255) / 255));
                        }
                     }
                  }
                  if(param1.blend < 1 && param1.testParamFlag(WindowParam.const_29))
                  {
                     ...
                     _loc4_.draw(var_91,var_927,_colorTransform,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
      ...
      {
         var _loc2_:ISkinRenderer = var_634.getSkinRendererByType(param1.type,param1.style);
         if(_loc2_ == null)
         {
            if(param1.style != WindowStyle.const_836)
            {
               _loc2_ = var_634.getSkinRendererByType(param1.type,WindowStyle.const_836);
            }
         }
         return _loc2_;
      }
