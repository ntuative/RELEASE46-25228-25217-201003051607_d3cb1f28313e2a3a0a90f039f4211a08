package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      {
         return new Rectangle(var_617 * maxScrollH,var_365 * maxScrollV,width,height);
      }
      ...
      {
         var_617 = param1;
         _field.scrollH = var_617 * Number(_field.maxScrollH);
         refreshTextImage();
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_881,true));
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_481,true));
         ...
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_481,true));
         ...
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_533,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_533,true));
         _loc1_.push(new PropertyStruct("word_wrap",_field.wordWrap,PropertyStruct.const_56,true));
         _loc1_.push(new PropertyStruct("margin_left",var_68.left,PropertyStruct.const_61,true));
         _loc1_.push(new PropertyStruct("margin_top",var_68.top,PropertyStruct.const_61,true));
         _loc1_.push(new PropertyStruct("margin_right",var_68.right,PropertyStruct.const_61,true));
         _loc1_.push(new PropertyStruct("margin_bottom",var_68.bottom,PropertyStruct.const_61,true));
         ...
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_533,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
