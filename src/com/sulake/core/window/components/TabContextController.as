package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      public function get container() : IWindowContainer
      {
         if(var_1589 == null)
         {
            var_1589 = findChildByTag(TabContextController.const_1119) as IWindowContainer;
         }
         return var_1589;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_931 == null)
         {
            var_931 = findChildByTag(TabContextController.const_1120) as ITabSelectorWindow;
            if(var_931 != null)
            {
      ...
      {
         return !!var_806 ? selector.iterator : null;
      }
