   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_334)
         {
            ...
            if(var_334)
            {
               var_334.addEventListener(WindowEvent.const_228,scrollBarEventProc);
               var_334.addEventListener(WindowEvent.const_207,scrollBarEventProc);
            }
         }
         return var_334;
      }
      ...
      override public function dispose() : void
      {
         if(var_334)
         {
            var_334.removeEventListener(WindowEvent.const_228,scrollBarEventProc);
            var_334.removeEventListener(WindowEvent.const_207,scrollBarEventProc);
            var_334 = null;
         }
         if(var_779)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_779)
         {
            var_779 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_779;
      }
