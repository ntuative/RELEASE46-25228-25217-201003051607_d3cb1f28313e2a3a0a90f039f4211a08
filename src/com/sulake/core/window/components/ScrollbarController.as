package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_1127:String = "increment";
      
      private static const const_495:String = "slider_bar";
      
      private static const const_1128:String = "decrement";
      ...
      {
         return findChildByName(ScrollbarController.const_783) as WindowController;
      }
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(param2.name == ScrollbarController.const_1127)
            {
               if(var_21)
               {
                  var_605 = true;
            ...
            else if(param2.name == ScrollbarController.const_1128)
            {
               if(var_21)
               {
                  var_605 = true;
            ...
            else if(param2.name == ScrollbarController.const_783)
            {
               _loc4_ = new Point();
