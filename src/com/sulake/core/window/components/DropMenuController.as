package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow
   {
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         {
            var_121 = context.create(name + "::submenu","",WindowType.const_385,var_81,0 | 0,_loc1_,subMenuEventProc,null,0,null,[WindowController.EXCLUDE_CHILD_TAG]) as DropMenuController;
         }
         else
         {
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_476,var_81,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         if(var_439 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(var_439).setStateFlag(WindowState.const_46,true);
         }
      }
      ...
      protected function openMenuView() : void
      {
         if(!var_536)
         {
            if(open())
            {
               if(false)
               {
                  populateMenuItemContainer(var_438,getSubMenu(),subMenuEventProc);
                  var_536 = true;
               }
            }
         }
      ...
      public function set selection(param1:int) : void
      {
         ...
         var _loc2_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_399,this,null,true);
         update(this,_loc2_);
      ...
      protected function closeMenuView() : void
      {
         if(close())
         {
            ...
            var_536 = false;
            getTitleText().text = var_439 < var_438.length && var_439 > -1 ? "null" : caption;
         }
      }
   }
}
