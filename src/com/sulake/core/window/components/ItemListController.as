package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow
   {
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_162 = var_744 || !testParamFlag(WindowParam.const_29);
         _container = _context.create("_CONTAINER","",WindowType.const_318,WindowStyle.const_299,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[WindowController.INTERNAL_CHILD_TAG,WindowController.EXCLUDE_CHILD_TAG]) as IWindowContainer;
         ...
         _container.addEventListener(WindowEvent.const_281,containerEventHandler);
      ...
      {
         return new Rectangle(var_526 * maxScrollH,var_525 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         ...
         _container.removeEventListener(WindowEvent.const_281,containerEventHandler);
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1024,_spacing,PropertyStruct.const_61,_spacing != DEF_SPACING));
         _loc1_.push(new PropertyStruct(const_1025,var_742,PropertyStruct.const_56,var_742 != const_1391));
         _loc1_.push(new PropertyStruct(const_1022,var_524,PropertyStruct.const_56,var_524 != const_1390));
         _loc1_.push(new PropertyStruct(const_1023,var_1100,PropertyStruct.const_56,var_1100 != DEF_RESIZE_ON_ITEM_UPDATE));
         return _loc1_;
      }
