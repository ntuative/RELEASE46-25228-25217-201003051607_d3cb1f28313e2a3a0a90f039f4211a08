package com.sulake.core.window.events
{
   ...
   public class WindowKeyboardEvent extends WindowEvent
   {
      ...
      {
         _type = param1;
         var_728 = KeyboardEvent(param2);
         super(param1,param3,param4,param5,false);
      }
      
      public function get keyLocation() : uint
      {
         return var_728.keyLocation;
      }
      
      public function get shiftKey() : Boolean
      {
         return var_728.shiftKey;
      }
      
      public function get charCode() : uint
      {
         return var_728.charCode;
      }
      
      public function get keyCode() : uint
      {
         return var_728.keyCode;
      }
      
      public function get altKey() : Boolean
      {
         return var_728.altKey;
      }
      ...
      {
         return new WindowKeyboardEvent(_type,var_728,window,related,bubbles,cancelable);
      }
   }
}
