package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_887:String = "AssetLibraryReady";
      
      public static const const_1187:String = "AssetLibraryUnloaded";
      
      public static const const_405:String = "AssetLibraryLoaded";
      
      public static const const_1326:String = "AssetLibraryLoadError";
       
      
      private var var_520:XML;
      ...
      private var var_521:Boolean = true;
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_610;
         var_429 = new Dictionary(false);
         var_430 = new Dictionary(false);
         var_739 = new Dictionary(false);
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in var_429)
         {
            _loc4_ = AssetTypeDeclaration(var_429[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      public function unload() : void
      {
         ...
         var_313 = false;
         _file = null;
         dispatchEvent(new Event(AssetLibrary.const_1187));
      }
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_520 = _loc2_.manifest.copy();
         var_358 = _loc2_.resource;
         if(var_521)
         {
            AssetLibrary.fetchLibraryContents(this,var_520,var_358);
         }
         var_313 = true;
         dispatchEvent(new Event(AssetLibrary.const_405));
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = var_430[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_825,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_815,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_803,assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         var_430[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(var_429.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_429[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         {
            _loc3_ = AssetTypeDeclaration(var_429[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      {
         var _loc2_:Class = var_739[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = var_520.child("library");
         if(_loc2_ == null)
         {
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = var_430[loader.url];
         if(struct == null)
         {
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(var_429[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
