package deng.fzip
{
   ...
   public class FZip extends EventDispatcher
   {
      ...
      protected function progressHandler(param1:Event) : void
      {
         ...
         {
            close();
            if(!hasEventListener(FZipErrorEvent.const_547))
            {
               throw e;
            }
            dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_547,e.message));
         }
      }
      ...
      public function loadBytes(param1:ByteArray) : void
      {
         if(!var_92 && parseFunc == parseIdle)
         {
            ...
            {
               dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_547,"EOF"));
            }
         }
      }
      ...
      private function parseLocalfile(param1:IDataInput) : Boolean
      {
         if(var_454.parse(param1))
         {
            ...
            if(false)
            {
               var_126["null"] = var_454;
            }
            dispatchEvent(new FZipEvent(FZipEvent.const_1346,var_454));
            var_454 = null;
      ...
      {
         var _loc2_:* = null;
         if(var_44 != null && var_126 != null && param1 < var_44.length)
         {
