package deng.fzip
{
   ...
   public class FZipFile
   {
      ...
      public static const const_645:int = 8;
      ...
      public static const const_1578:int = 9;
      
      public static const const_1438:int = 7;
      ...
      private var var_1571:String = "2.0";
      ...
      {
         var _loc2_:* = 0;
         if(var_732 === const_645 && !var_1572)
         {
            if(var_1079)
            {
               param1.readBytes(var_20,0,var_179);
            }
            else
            {
               if(!var_510)
               ...
               _loc2_ = uint(~var_2207 << 6 & 192);
               _loc2_ += 31 - (30720 | _loc2_) % 31;
               var_20.writeByte(_loc2_);
               param1.readBytes(var_20,2,var_179);
               var_20.position = var_20.length;
               var_20.writeUnsignedInt(var_908);
            }
            var_178 = true;
         }
         else
         {
            if(var_732 != const_1207)
            {
               throw new Error("Compression method " + var_732 + " is not supported.");
            }
            param1.readBytes(var_20,0,var_179);
            var_178 = false;
         }
      ...
      private function method_6(param1:IDataInput) : Boolean
      {
         if(param1.bytesAvailable >= 30)
         {
            parseHead(param1);
            if(var_1080 + var_1339 > 0)
            {
      ...
      public function setContentAsString(param1:String, param2:String = "utf-8") : void
      {
         ...
         if(param1 != null && param1.length > 0)
         {
            ...
            var_731 = ChecksumUtil.CRC32(var_20);
            var_510 = false;
         }
         compress();
      }
      ...
      {
         var_730 = param1 != null ? param1 : new Date();
      }
      ...
      public function serialize(param1:IDataOutput, param2:Boolean, param3:Boolean = false, param4:uint = 0) : uint
      {
         ...
         if(param3)
         {
            ...
            param1.writeShort(var_1338 << 8 | 20);
         }
         else
         {
         ...
         param1.writeShort(const_645);
         var _loc5_:Date = var_730 != null ? var_730 : new Date();
         ...
         {
            _loc8_.writeMultiByte(var_426,var_355);
         }
         ...
         if(param2)
         {
            if(!var_510)
            {
               ...
               var_908 = ChecksumUtil.Adler32(var_20,0,var_20.length);
               var_510 = true;
               if(_loc16_)
               {
                  compress();
         ...
         if(param3 && false)
         {
            if(var_355 == "utf-8")
            {
               _loc8_.writeUTFBytes(var_2208);
            }
            else
            {
               _loc8_.writeMultiByte(var_2208,var_355);
            }
         }
      ...
      protected function compress() : void
      {
         if(!var_178)
         {
            ...
            {
               var_20.position = 0;
               var_604 = var_20.length;
               if(var_1079)
               {
                  var_20.compress.apply(var_20,["deflate"]);
                  var_179 = var_20.length;
               }
               else
               {
                  var_20.compress();
      ...
      {
         if(param1.bytesAvailable >= var_1080 + var_1339)
         {
            parseHeadExt(param1);
            parseFunc = parseFileContent;
            return true;
      ...
      protected function parseHeadExt(param1:IDataInput) : void
      {
         ...
         if(var_355 == "utf-8")
         {
            var_426 = param1.readUTFBytes(var_1080);
         }
         else
         {
            var_426 = param1.readMultiByte(var_1080,var_355);
         }
         var _loc2_:uint = var_1339;
         while(_loc2_ > 4)
         {
            ...
            if(_loc4_ > _loc2_)
            {
               throw new Error("Parse error in file " + var_426 + ": Extra field data size too big.");
            }
      ...
      protected function parseHead(param1:IDataInput) : void
      {
         ...
         var_1338 = _loc2_ >> 8;
         var_1571 = Math.floor((_loc2_ & 255) / 10) + "." + (_loc2_ & 255) % 10;
         var _loc3_:uint = param1.readUnsignedShort();
         var_732 = param1.readUnsignedShort();
         var_1572 = (_loc3_ & 1) !== 0;
         var_1573 = (_loc3_ & 8) !== 0;
         var_2206 = (_loc3_ & 32) !== 0;
         if((_loc3_ & 800) !== 0)
         {
            var_355 = "utf-8";
         }
         if(var_732 === const_1267)
         {
            var_2326 = (_loc3_ & 2) !== 0 ? 8192 : 4096;
            var_2327 = (_loc3_ & 4) !== 0 ? 3 : 2;
         }
         else if(var_732 === const_645)
         {
            var_2207 = (_loc3_ & 6) >> 1;
         }
         ...
         var_730 = new Date(_loc11_,_loc10_ - 1,_loc9_,_loc8_,_loc7_,_loc6_,0);
         ...
         var_1339 = param1.readUnsignedShort();
      }
      ...
      {
         return "[FZipFile]\n  name:" + var_426 + "\n  date:" + var_730 + "\n  sizeCompressed:" + var_179 + "\n  sizeUncompressed:" + var_604 + "\n  versionHost:" + var_1338 + "\n  versionNumber:" + var_1571 + "\n  compressionMethod:" + var_732 + "\n  encrypted:" + var_1572 + "\n  hasDataDescriptor:" + var_1573 + "\n  hasCompressedPatchedData:" + var_2206 + "\n  filenameEncoding:" + var_355 + "\n  crc32:" + var_731.toString(16) + "\n  adler32:" + var_908.toString(16);
      }
